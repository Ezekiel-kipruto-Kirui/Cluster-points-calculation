import{u as Zn,j as e,L as ln,r as o,P as re,a as mn,N as on,R as ie,A as te,S as se,b as Fn,T as Bn,E as ae,c as oe,C as Ee,d as Ie,X as le,e as ce,f as Ne,g as Ue,h as tn,i as Ae,k as Te,B as ye}from"./vendor-1jWIULEY.js";(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))t(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const I of a.addedNodes)I.tagName==="LINK"&&I.rel==="modulepreload"&&t(I)}).observe(document,{childList:!0,subtree:!0});function n(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function t(s){if(s.ep)return;s.ep=!0;const a=n(s);fetch(s.href,a)}})();const Ce=[{path:"/",label:"Home"},{path:"/calculator",label:"Calculator"},{path:"/admin",label:"Login"}];function Se({children:r}){const{pathname:i}=Zn(),n=t=>`rounded-lg px-3 py-2 text-sm font-medium transition ${i===t?"bg-gradient-to-r from-slate-900 to-slate-700 text-white shadow-sm":"text-slate-700 hover:bg-slate-100"}`;return e.jsxs("div",{className:"min-h-screen bg-mesh text-slate-900",children:[e.jsx("header",{className:"sticky top-0 z-20 border-b border-slate-200/80 bg-white/80 backdrop-blur",children:e.jsxs("div",{className:"mx-auto flex w-full max-w-7xl items-center justify-between px-4 py-4",children:[e.jsx(ln,{to:"/",className:"text-lg font-semibold tracking-tight text-slate-900",children:"Cluster Calculation"}),e.jsx("nav",{className:"flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-2 py-1 shadow-sm",children:Ce.map(t=>e.jsx(ln,{to:t.path,className:n(t.path),children:t.label},t.path))})]})}),e.jsx("main",{className:"mx-auto w-full max-w-7xl px-4 py-8",children:r})]})}const wn={danger:"border-rose-200 bg-rose-50 text-rose-700",warning:"border-amber-200 bg-amber-50 text-amber-700",success:"border-emerald-200 bg-emerald-50 text-emerald-700",info:"border-slate-200 bg-slate-50 text-slate-700"};function b({message:r,tone:i="info",className:n=""}){return r?e.jsx("p",{className:`rounded-lg border px-3 py-2 text-sm ${wn[i]||wn.info} ${n}`,children:r}):null}const Re=["A","A-","B+","B","B-","C+","C","C-","D+","D","D-","E"],ue=(r,i)=>{const n=Number(r);return Number.isFinite(n)?n:i},Oe="150".trim(),Pn=ue(Oe,0),de="".trim(),fn=de.replace(/\/+$/,""),me=r=>/^https?:\/\//i.test(r),k=r=>{const i=String(r||"").trim();if(!i)return fn||"";if(me(i)||!fn)return i;const n=i.startsWith("/")?i:`/${i}`;return`${fn}${n}`},Vn=async r=>{try{const i=await r.text();return i?JSON.parse(i):null}catch{return null}},Dn=(r,i)=>String((r==null?void 0:r.error)||(r==null?void 0:r.message)||i).trim()||i,he=({enabled:r=!0}={})=>{const[i,n]=o.useState(null),[t,s]=o.useState(null),[a,I]=o.useState(r),[N,U]=o.useState(!1),[T,l]=o.useState(""),O=o.useMemo(()=>!0,[]),y=o.useCallback(async()=>{I(!0);try{const C=await fetch(k("/api/admin/me"),{method:"GET",credentials:"include"}),Y=await Vn(C);if(!C.ok){n(null),s(null);return}n((Y==null?void 0:Y.user)||null),s((Y==null?void 0:Y.profile)||null),l("")}catch{n(null),s(null)}finally{I(!1)}},[]);o.useEffect(()=>{if(!r){I(!1);return}y().catch(()=>{})},[r,y]);const S=o.useCallback(async(C,Y)=>{U(!0),l("");try{const v=await fetch(k("/api/admin/login"),{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:String(C||"").trim(),password:String(Y||"")})}),h=await Vn(v);if(!v.ok){const H=v.status===404?"Admin login endpoint not found. Check VITE_API_BASE_URL or backend routes.":Dn(h,"Authentication request failed.");return l(H),{success:!1,error:H}}return n((h==null?void 0:h.user)||null),s((h==null?void 0:h.profile)||null),l(""),{success:!0,user:(h==null?void 0:h.user)||void 0,profile:(h==null?void 0:h.profile)||void 0,error:""}}catch(v){const h=(v==null?void 0:v.message)||"Authentication request failed.";return l(h),{success:!1,error:h}}finally{U(!1)}},[]),L=o.useCallback(async()=>{const C="Google popup login is disabled in backend-auth mode. Use email and password.";return l(C),{success:!1,error:C}},[]),d=o.useCallback(async()=>{U(!0);try{await fetch(k("/api/admin/logout"),{method:"POST",credentials:"include"})}finally{n(null),s(null),l(""),U(!1)}},[]),m=o.useCallback(async({email:C,password:Y,name:v})=>{if(!i||!t)throw new Error("You must be logged in as admin.");if(t.role!=="super")throw new Error("Only a super admin can add regular admin users.");const h=await fetch(k("/api/admin/regular-admin"),{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:String(C||"").trim(),password:String(Y||""),name:String(v||"").trim()})}),H=await Vn(h);if(!h.ok)throw new Error(Dn(H,"Unable to create regular admin."));return{user:(H==null?void 0:H.user)||null,profile:(H==null?void 0:H.profile)||null}},[t,i]);return{firebaseAuthReady:O,adminUser:i,adminProfile:t,authLoading:a,authWorking:N,authError:T,isAdminAuthenticated:!!(i&&t),login:S,loginWithGoogle:L,logout:d,addRegularAdmin:m}},bn={A:12,"A-":11,"B+":10,B:9,"B-":8,"C+":7,C:6,"C-":5,"D+":4,D:3,"D-":2,E:1},xn={ENG:"English",KIS:"Kiswahili",MAT:"Mathematics",BIO:"Biology",CHE:"Chemistry",PHY:"Physics",GSC:"General Science",HAG:"History",GEO:"Geography",CRE:"CRE",IRE:"IRE",HRE:"HRE",CMP:"Computer Studies",AGR:"Agriculture",ARD:"Art & Design",HSC:"Home Science",BST:"Business Studies",FRE:"French",GER:"German",MUS:"Music",ARB:"Arabic"},jn=[{title:"Group I",required:!0,subjects:["ENG","KIS","MAT"]},{title:"Group II (Sciences)",required:!1,subjects:["BIO","CHE","PHY","GSC"]},{title:"Group III (Humanities)",required:!1,subjects:["HAG","GEO","CRE","IRE","HRE"]},{title:"Group IV (Technical)",required:!1,subjects:["CMP","AGR","ARD","HSC"]},{title:"Group V (Others)",required:!1,subjects:["BST","FRE","GER","MUS","ARB"]}],ge=["ENG","KIS","MAT"],K=["BIO","CHE","PHY","GSC"],V=["HAG","GEO","CRE","IRE","HRE"],F=["CMP","AGR","ARD","HSC"],B=["BST","FRE","GER","MUS","ARB"],Rn=[...ge,...K,...V,...F,...B],E=(r,i)=>Math.max(...i.map(n=>n in r?r[n]:0),0),P=(r,i,n)=>{const t=i.filter(s=>s in r).map(s=>r[s]).sort((s,a)=>a-s);return t.length>=n?t[n-1]:0},ve=r=>{const i=Object.values(r).sort((n,t)=>t-n);return i.length>=7?i.slice(0,7).reduce((n,t)=>n+t,0):0},Ye=(r,i)=>Number((Math.sqrt(r/48*(i/84))*48*.94).toFixed(3)),Me=r=>["BIO","CHE","MAT","PHY"].every(n=>r[n]&&r[n]in bn),fe=(r,i)=>{const n={};for(const[I,N]of Object.entries(i))N in bn&&(n[I]=bn[N]);if(Object.keys(n).length<7)return 0;const t=ve(n),s=()=>0;let a=0;if(r===1){if(!("ENG"in n||"KIS"in n))return s();a=E(n,["ENG","KIS"])+Math.max(n.MAT??0,E(n,K))+E(n,V)+Math.max(E(n,K),P(n,V,2),E(n,F),E(n,B))}else if(r===2){if(!("ENG"in n||"KIS"in n))return s();a=E(n,["ENG","KIS"])+(n.MAT??0)+Math.max(E(n,K),E(n,V))+Math.max(E(n,K),E(n,V),E(n,F),E(n,B))}else if(r===3){if(!("ENG"in n||"KIS"in n))return s();a=E(n,["ENG","KIS"])+Math.max(n.MAT??0,E(n,K))+E(n,V)+Math.max(E(n,K),P(n,V,2),E(n,F),E(n,B))}else if(r===4){if(!("MAT"in n&&"PHY"in n))return s();a=n.MAT+n.PHY+Math.max(n.BIO??0,n.CHE??0,n.GEO??0)+Math.max(E(n,K),E(n,V),E(n,F),E(n,B))}else if(r===5){if(!("MAT"in n&&"PHY"in n&&"CHE"in n))return s();a=n.MAT+n.PHY+n.CHE+Math.max(n.BIO??0,E(n,V),E(n,F),E(n,B))}else if(r===6){if(!("MAT"in n&&"PHY"in n))return s();a=n.MAT+n.PHY+E(n,V)+Math.max(P(n,K,2),P(n,V,2),E(n,F),E(n,B))}else if(r===7){if(!("MAT"in n&&"PHY"in n))return s();a=n.MAT+n.PHY+Math.max(P(n,K,2),E(n,V))+Math.max(E(n,K),E(n,V),E(n,F),E(n,B))}else if(r===8){if(!("MAT"in n&&"BIO"in n))return s();a=n.MAT+n.BIO+Math.max(n.PHY??0,n.CHE??0)+Math.max(P(n,K,3),E(n,V),E(n,F),E(n,B))}else if(r===9){if(!("MAT"in n))return s();a=n.MAT+E(n,K)+P(n,K,2)+Math.max(P(n,K,3),E(n,V),E(n,F),E(n,B))}else if(r===10){if(!("MAT"in n))return s();a=n.MAT+E(n,K)+E(n,V)+Math.max(P(n,K,2),P(n,V,2),E(n,F),E(n,B))}else if(r===11)a=Math.max((n.CHE??0)+Math.max(n.MAT??0,n.PHY??0)+Math.max(n.BIO??0,n.HSC??0)+Math.max(E(n,["ENG","KIS"]),E(n,V),E(n,F),E(n,B)),Math.max(n.BIO??0,n.GSC??0)+(n.MAT??0)+Math.max(E(n,K),E(n,V))+Math.max(E(n,["ENG","KIS"]),E(n,K),E(n,V),E(n,F),E(n,B)));else if(r===12||r===13){if(!("BIO"in n&&"CHE"in n))return s();a=n.BIO+n.CHE+Math.max(n.MAT??0,n.PHY??0)+Math.max(E(n,["ENG","KIS"]),P(n,K,3),E(n,V),E(n,F),E(n,B))}else if(r===14){if(!("CHE"in n))return s();a=Math.max(n.BIO??0,n.AGR??0,n.HSC??0)+n.CHE+Math.max(n.MAT??0,n.PHY??0,n.GEO??0)+Math.max(E(n,["ENG","KIS"]),E(n,V),E(n,F),E(n,B))}else if(r===15){if(!("BIO"in n&&"CHE"in n))return s();a=n.BIO+n.CHE+Math.max(n.MAT??0,n.PHY??0,n.AGR??0)+Math.max(E(n,["ENG","KIS"]),E(n,V),E(n,F),E(n,B))}else if(r===16){if(!("GEO"in n))return s();a=n.GEO+(n.MAT??0)+E(n,K)+Math.max(P(n,K,2),P(n,V,2),E(n,F),E(n,B))}else if(r===17){if(!("FRE"in n||"GER"in n))return s();a=E(n,["FRE","GER"])+E(n,["ENG","KIS"])+Math.max(n.MAT??0,E(n,K),E(n,V))+Math.max(E(n,K),E(n,V),E(n,F),P(n,B,2))}else if(r===18){if(!("MUS"in n))return s();a=n.MUS+E(n,["ENG","KIS"])+Math.max(n.MAT??0,E(n,K),E(n,V))+Math.max(E(n,K),E(n,V),E(n,F),P(n,B,2))}else if(r===19)a=E(n,Rn)+P(n,Rn,2)+P(n,Rn,3)+P(n,Rn,4);else if(r===20){if(!(n.CRE||n.IRE||n.HRE))return s();a=E(n,["CRE","IRE","HRE"])+E(n,["ENG","KIS"])+P(n,V,2)+Math.max(E(n,K),E(n,F),E(n,B))}else return s();return Ye(a,t)},Ve=r=>{const i={};for(let n=1;n<=20;n+=1)i[n]=fe(n,r);return i},zn="kuccps.cluster.sessions",en={catalog:k("/api/catalog"),adminCatalogUpload:k("/api/admin/catalog/upload"),adminCatalogCourse:k("/api/admin/catalog/course"),sessions:k("/api/sessions"),adminSessions:k("/api/admin/sessions"),adminSessionsBulkDelete:k("/api/admin/sessions/delete-many"),adminMe:k("/api/admin/me")},hn=async r=>{try{const i=await r.text();return i?JSON.parse(i):null}catch{return null}},pn=async r=>{const i=await fetch(r,{method:"GET",credentials:"include"}),n=await hn(i);return{ok:i.ok,status:i.status,data:n}},Cn=async(r,i)=>{const n=await fetch(r,{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify(i??{})}),t=await hn(n);return{ok:n.ok,status:n.status,data:t}},Ke=async(r,i)=>{const n=await fetch(r,{method:"PATCH",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify(i??{})}),t=await hn(n);return{ok:n.ok,status:n.status,data:t}},Le=async r=>{const i=await fetch(r,{method:"DELETE",credentials:"include"}),n=await hn(i);return{ok:i.ok,status:i.status,data:n}},rn=(r,i)=>{const n=(r==null?void 0:r.data)||{};return String((n==null?void 0:n.error)||(n==null?void 0:n.message)||i)},cn=r=>String(r||"").trim().toUpperCase().replace(/[^A-Z0-9]/g,""),Tn=r=>{const i=r&&typeof r=="object"?r:{},n={};for(let t=1;t<=20;t+=1){const s=Number(i[t]??i[String(t)]??0);n[t]=Number.isFinite(s)?s:0}return n},Gn=r=>{if(!r||typeof r!="object")return{};const i={};return Object.entries(r).forEach(([n,t])=>{const s=String(n||"").trim().toUpperCase(),a=String(t||"").trim().toUpperCase();!s||!a||(i[s]=a)}),i},gn=()=>{if(typeof window>"u")return{};try{const r=window.localStorage.getItem(zn);if(!r)return{};const i=JSON.parse(r);return i&&typeof i=="object"?i:{}}catch{return{}}},Qn=r=>{typeof window>"u"||window.localStorage.setItem(zn,JSON.stringify(r||{}))},un="ABCDEFGHJKLMNPQRSTUVWXYZ23456789",be=(r=8)=>{if(typeof crypto<"u"&&crypto.getRandomValues){const n=new Uint8Array(r);return crypto.getRandomValues(n),Array.from(n,t=>un[t%un.length]).join("")}let i="";for(let n=0;n<r;n+=1){const t=Math.floor(Math.random()*un.length);i+=un[t]}return i},xe=()=>{const r=gn();for(let i=0;i<20;i+=1){const n=be();if(!r[n])return n}throw new Error("Unable to generate a local access code.")},pe=r=>{const i=gn();i[r.code]=r,Qn(i)},Ge=(r,i="")=>({name:(r==null?void 0:r.name)||i,requirements:(r==null?void 0:r.requirements)||{},universities:Array.isArray(r==null?void 0:r.universities)?r.universities.map(n=>({name:String((n==null?void 0:n.name)||""),cutoff:Number((n==null?void 0:n.cutoff)??0),courseCode:String((n==null?void 0:n.courseCode)||"")})):[]}),He=r=>(Array.isArray(r)?r:Object.values(r||{})).map(n=>Ge(n)).filter(n=>!!n.name),Fe=r=>{if(!r||typeof r!="object")return{};const i={};return Object.entries(r).forEach(([n,t])=>{const s=Number(n);!Number.isInteger(s)||s<1||(i[s]=He(t))}),i},Be=()=>!0,we=async()=>{const r=await pn(en.catalog);if(!r.ok)throw new Error(rn(r,"Unable to load course catalog from backend."));return Fe(r.data||{})},Pe=async r=>{if(!r||typeof r!="object")throw new Error("Invalid course catalog payload.");const i=await Cn(en.adminCatalogUpload,r);if(!i.ok)throw new Error(rn(i,"Unable to upload course catalog to backend."))},De=async({cluster:r,name:i,requirements:n,universities:t})=>{const s=await Cn(en.adminCatalogCourse,{cluster:r,name:i,requirements:n,universities:t});if(!s.ok)throw new Error(rn(s,"Unable to save course entry to backend."));return s.data||{}},je=async({code:r,email:i,phoneNumber:n,amountPaid:t,grades:s,results:a,medicineEligible:I,paymentResponse:N})=>{const U={email:i,phoneNumber:n,amountPaid:t,grades:s,results:a,medicineEligible:I,paymentResponse:N};r&&(U.code=r);const T=await Cn(en.sessions,U);if(!T.ok)throw new Error(rn(T,"Unable to save session to backend."));const l=T.data||{};return{code:cn(l.code),email:String(l.email||"").trim(),phoneNumber:String(l.phoneNumber||"").trim(),amountPaid:Number(l.amountPaid??0),grades:Gn(l.grades),results:Tn(l.results),medicineEligible:!!l.medicineEligible,paymentResponse:l.paymentResponse||null,createdAt:String(l.createdAt||""),updatedAt:String(l.updatedAt||""),storage:"firebase"}},Xn=async()=>{const r=gn(),i=Object.entries(r);if(!i.length)return 0;let n=0;const t={...r};for(const[s,a]of i)try{const I={code:cn(a.code||s),email:String(a.email||"").trim(),phoneNumber:String(a.phoneNumber||"").trim(),amountPaid:Number(a.amountPaid??0),grades:a.grades||{},results:a.results||{},medicineEligible:!!a.medicineEligible,paymentResponse:a.paymentResponse||null},N=await Cn(en.sessions,I);if(!N.ok)throw new Error(rn(N,"Unable to sync session to backend."));delete t[s],n+=1}catch{}return n>0&&Qn(t),n},ke=async r=>{try{const i=await je(r);return Xn().catch(()=>{}),{session:i,storage:"firebase",warning:""}}catch(i){const n=new Date().toISOString(),s={code:xe(),email:String((r==null?void 0:r.email)||"").trim(),phoneNumber:String((r==null?void 0:r.phoneNumber)||"").trim(),amountPaid:Number((r==null?void 0:r.amountPaid)??0),grades:(r==null?void 0:r.grades)||{},results:Tn((r==null?void 0:r.results)||{}),medicineEligible:!!(r!=null&&r.medicineEligible),paymentResponse:(r==null?void 0:r.paymentResponse)||null,createdAt:n,updatedAt:n,storage:"local"};return pe(s),{session:s,storage:"local",warning:(i==null?void 0:i.message)||"Backend save failed. Session saved locally on this browser only."}}},Je=async r=>{const i=cn(r);if(!i)return null;const n=await pn(`${en.sessions}/${i}`);if(n.ok&&n.data){const s=n.data;return{code:i,email:String(s.email||"").trim(),phoneNumber:String(s.phoneNumber||"").trim(),amountPaid:Number(s.amountPaid??0),grades:Gn(s.grades),results:Tn(s.results),medicineEligible:!!s.medicineEligible,paymentResponse:s.paymentResponse||null,createdAt:String(s.createdAt||""),updatedAt:String(s.updatedAt||""),storage:"firebase"}}const t=gn()[i];if(t)return{code:i,email:t.email||"",phoneNumber:t.phoneNumber||"",amountPaid:Number(t.amountPaid??0),grades:t.grades||{},results:Tn(t.results||{}),medicineEligible:!!t.medicineEligible,paymentResponse:t.paymentResponse||null,createdAt:t.createdAt||"",updatedAt:t.updatedAt||"",storage:"local"};if(n.status!==404)throw new Error(rn(n,"Unable to load session from backend."));return null},qe=async()=>{const r=await pn(en.adminSessions);if(!r.ok)throw new Error(rn(r,"Unable to load calculated sessions from backend."));return(Array.isArray(r.data)?r.data:[]).map(n=>({code:cn(n.code),email:String(n.email||"").trim(),phoneNumber:String(n.phoneNumber||"").trim(),amountPaid:Number(n.amountPaid??0),createdAt:String(n.createdAt||""),updatedAt:String(n.updatedAt||""),medicineEligible:!!n.medicineEligible,grades:Gn(n.grades),results:Tn(n.results),paymentResponse:n.paymentResponse||null,storage:"firebase"})).filter(n=>n.code).sort((n,t)=>(Date.parse(t.createdAt||"")||0)-(Date.parse(n.createdAt||"")||0))},$e=async(r,i={})=>{const n=cn(r);if(!n)throw new Error("Session code is required.");const t=await Ke(`${en.adminSessions}/${n}`,i);if(!t.ok)throw new Error(rn(t,"Unable to update session."))},_e=async r=>{const i=cn(r);if(!i)throw new Error("Session code is required.");const n=await Le(`${en.adminSessions}/${i}`);if(!n.ok)throw new Error(rn(n,"Unable to delete session."))},We=async(r=[])=>{var n;const i=await Cn(en.adminSessionsBulkDelete,{codes:Array.isArray(r)?r:[]});if(!i.ok)throw new Error(rn(i,"Unable to delete selected sessions."));return Number(((n=i.data)==null?void 0:n.deleted)??0)},En={courseName:"COURSE NAME",cluster:"CLUSTER",courseCode:"COURSE CODE",university:"UNIVERSITY",cutoff:"CUT-OFF POINTS",requirements:"MINIMUM SUBJECT REQUIREMENTS"},sn=r=>String(r??"").replace(/\u00a0/g," ").trim(),Ze=r=>{const i=sn(r).replace(/,/g,"");if(!i||i==="-")return 0;const n=Number.parseFloat(i);return Number.isFinite(n)?n:0},kn=r=>{const i=sn(r);if(!i||/^none$/i.test(i)||i==="-")return[];const n=[];return i.split(/\r?\n|;/).map(t=>t.trim()).filter(Boolean).forEach(t=>{if(/^none$/i.test(t)||t==="-")return;const s=t.indexOf(":");if(s<0)return;const a=t.slice(0,s).trim(),I=t.slice(s+1).trim().toUpperCase();!a||!I||I==="-"||n.push({subject:a,grade:I})}),n},ze=(r=[],i=[])=>{const n=[...r];return i.forEach(t=>{if(!(t!=null&&t.subject)||!(t!=null&&t.grade))return;const s=n.findIndex(a=>a.subject===t.subject);s>=0?n[s]=t:n.push(t)}),n},Qe=r=>{const i=new Set,n=[];return r.forEach(t=>{const s=`${t.name}|${t.courseCode}`;!t.name||i.has(s)||(i.add(s),n.push(t))}),n},Xe=r=>Object.values(En).some(i=>sn(r==null?void 0:r[i])),ne=r=>{const i=re.parse(r,{header:!0,skipEmptyLines:!1});if(!Array.isArray(i.data)||!i.data.length)throw new Error("CSV has no records.");const n={};let t=null;const s=()=>{t&&(n[t.cluster]||(n[t.cluster]=[]),n[t.cluster].push({name:t.name,requirements:t.requirements,universities:Qe(t.universities)}),t=null)};if(i.data.forEach(a=>{if(!a||typeof a!="object"||!Xe(a))return;const I=sn(a[En.courseName]),N=sn(a[En.cluster]),U=sn(a[En.courseCode]),T=sn(a[En.university]),l=sn(a[En.cutoff]),O=sn(a[En.requirements]),y=Number(N);if(!!(I&&Number.isInteger(y)&&y>0))s(),t={name:I,cluster:y,requirements:kn(O),universities:[]};else if(!t)return;O&&(t.requirements=ze(t.requirements,kn(O))),(T||U||l)&&t.universities.push({name:T||"Unknown University",courseCode:U,cutoff:Ze(l)})}),s(),!Object.keys(n).length)throw new Error("CSV did not produce a valid course catalog.");return n},nr=r=>{const i=Object.keys(r||{}).length;let n=0,t=0;return Object.values(r||{}).forEach(s=>{Array.isArray(s)&&(n+=s.length,s.forEach(a=>{t+=Array.isArray(a.universities)?a.universities.length:0}))}),{clusters:i,courses:n,universities:t}},er=`COURSE NAME,CLUSTER,COURSE CODE,UNIVERSITY,CUT-OFF POINTS,MINIMUM SUBJECT REQUIREMENTS\r
...
,,1114488,University of Eldoret,15.092,\r
,,1093488,University of Embu,15.092,\r
`,rr=r=>{if(!Array.isArray(r))return{};const i={};return r.forEach(n=>{const t=String((n==null?void 0:n.subject)||"").trim(),s=String((n==null?void 0:n.grade)||"").trim().toUpperCase();!t||!s||(i[t]=s)}),i},ir=r=>{if(!r||typeof r!="object")return{};const i={};return Object.entries(r).forEach(([n,t])=>{const s=Number(n);if(!Number.isInteger(s)||s<1)return;const a=Array.isArray(t)?t:[];i[s]=a.map(I=>({name:String((I==null?void 0:I.name)||"").trim(),requirements:rr(I==null?void 0:I.requirements),universities:Array.isArray(I==null?void 0:I.universities)?I.universities.map(N=>({name:String((N==null?void 0:N.name)||"").trim(),courseCode:String((N==null?void 0:N.courseCode)||"").trim(),cutoff:Number((N==null?void 0:N.cutoff)??0)})).filter(N=>!!N.name):[]})).filter(I=>!!I.name)}),i};let On=null;const Jn=()=>{if(On)return On;const r=ne(er);return On=ir(r),On},tr=({mode:r="public"}={})=>{const[i,n]=o.useState({}),[t,s]=o.useState(!0),[a,I]=o.useState(""),N=o.useCallback(async()=>{if(s(!0),r!=="admin"){try{const l=Jn();n(l),I("")}catch(l){n({}),I((l==null?void 0:l.message)||"Unable to load bundled course catalog.")}finally{s(!1)}return}try{const l=await we();n(l),I("")}catch(l){const O=Jn();n(O);const y=(l==null?void 0:l.message)||"Unable to load courses from realtime database.";I(`${y} Showing bundled courses until backend connection is available.`)}finally{s(!1)}},[r]),U=o.useCallback(async l=>{if(r!=="admin")throw new Error("Catalog updates are only available in admin mode.");await Pe(l),I(""),await N()},[N,r]),T=o.useCallback(async l=>{if(r!=="admin")throw new Error("Catalog updates are only available in admin mode.");await De(l),I(""),await N()},[N,r]);return o.useEffect(()=>{N().catch(()=>{})},[N]),{courseCatalog:i,catalogLoading:t,courseCatalogError:a,loadCatalog:N,saveCatalog:U,saveSingleCourse:T}};function sr({isAuthenticated:r,onLogin:i,onGoogleLogin:n,authError:t,isLoading:s}){const a=mn(),[I,N]=o.useState(""),[U,T]=o.useState(""),[l,O]=o.useState(!1),[y,S]=o.useState("");if(r)return e.jsx(on,{to:"/admin",replace:!0});const L=async m=>{m.preventDefault(),S("");const C=await i(I,U);if(C.success){a("/admin");return}S(C.error||"Invalid admin credentials.")},d=async()=>{S("");const m=await n();if(m.success){a("/admin");return}S(m.error||"Google sign-in failed.")};return e.jsxs("section",{className:"mx-auto max-w-lg rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsx("h1",{className:"text-2xl font-semibold tracking-tight",children:"Admin Login"}),e.jsx("p",{className:"mt-2 text-sm text-slate-600",children:"Only admins can upload course data to Firebase."}),e.jsxs("form",{onSubmit:L,className:"mt-6 space-y-4",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"admin_email",className:"mb-1 block text-sm font-medium text-slate-700",children:"Email"}),e.jsx("input",{id:"admin_email",type:"email",value:I,onChange:m=>N(m.target.value),required:!0,className:"ui-input",placeholder:"admin@example.com"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"admin_password",className:"mb-1 block text-sm font-medium text-slate-700",children:"Password"}),e.jsxs("div",{className:"relative",children:[e.jsx("input",{id:"admin_password",type:l?"text":"password",value:U,onChange:m=>T(m.target.value),required:!0,className:"ui-input pr-20"}),e.jsx("button",{type:"button",onClick:()=>O(m=>!m),className:"absolute right-2 top-1/2 -translate-y-1/2 rounded-lg border border-slate-200 bg-white px-2.5 py-1 text-xs font-semibold text-slate-600 transition hover:bg-slate-50",children:l?"Hide":"View"})]})]}),e.jsx(b,{tone:"danger",message:y}),e.jsx(b,{tone:"danger",message:t}),e.jsx("button",{type:"submit",disabled:s,className:"inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-slate-900 to-slate-700 px-4 py-2 text-sm font-semibold text-white transition hover:from-slate-800 hover:to-slate-700",children:s?"Signing in...":"Login"}),e.jsxs("div",{className:"relative py-1",children:[e.jsx("div",{className:"absolute inset-0 flex items-center",children:e.jsx("span",{className:"w-full border-t border-slate-200"})}),e.jsx("div",{className:"relative flex justify-center",children:e.jsx("span",{className:"bg-white px-2 text-xs text-slate-500",children:"OR"})})]}),e.jsx("button",{type:"button",onClick:d,disabled:s,className:"inline-flex w-full items-center justify-center rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-100 disabled:cursor-not-allowed disabled:text-slate-400",children:"Continue with Google"})]})]})}const ar="/assets/courses-CtX9VR_p.csv",or=r=>new Promise((i,n)=>{const t=new FileReader;t.onload=()=>i(String(t.result||"")),t.onerror=()=>n(new Error("Unable to read selected file.")),t.readAsText(r)});function Er({firebaseConfigured:r,onUploadCatalog:i,bundledCoursesCsvUrl:n}){const[t,s]=o.useState(""),[a,I]=o.useState(""),[N,U]=o.useState(!1),[T,l]=o.useState(null),O=async(d,m)=>{s(""),I(""),U(!0);try{const C=ne(d);await i(C);const Y=nr(C);I(`${m} uploaded: ${Y.clusters} clusters, ${Y.courses} courses, ${Y.universities} universities.`)}catch(C){s(C.message||"Failed to upload course catalog.")}finally{U(!1)}},y=async()=>{if(!T){s("Select a CSV file first.");return}try{const d=await or(T);await O(d,T.name)}catch(d){s(d.message||"Failed to read selected CSV file.")}},S=async()=>{try{const d=await fetch(n);if(!d.ok)throw new Error(`Unable to load bundled CSV (status ${d.status}).`);const m=await d.text();await O(m,"courses.csv")}catch(d){s(d.message||"Failed to upload bundled courses.csv.")}},L=d=>{var m;l(((m=d.target.files)==null?void 0:m[0])||null)};return e.jsxs("section",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsx("h2",{className:"text-xl font-semibold tracking-tight",children:"Courses Upload"}),e.jsx("p",{className:"mt-1 text-sm text-slate-600",children:"Upload a `courses.csv` compatible file through backend API into Firebase realtime database."}),r?null:e.jsx(b,{className:"mt-4",tone:"warning",message:"Backend Firebase integration is not available."}),e.jsxs("div",{className:"mt-5 flex flex-col gap-3 sm:flex-row sm:items-end",children:[e.jsxs("div",{className:"w-full sm:max-w-md",children:[e.jsx("label",{htmlFor:"admin_csv_upload",className:"mb-1 block text-sm font-medium text-slate-700",children:"Select CSV file"}),e.jsx("input",{id:"admin_csv_upload",type:"file",accept:".csv,text/csv",onChange:L,className:"ui-file-input"})]}),e.jsx("button",{type:"button",onClick:y,disabled:N||!r,className:"inline-flex items-center justify-center rounded-lg bg-slate-900 px-4 py-2 text-sm font-semibold text-white transition enabled:hover:bg-slate-800 disabled:cursor-not-allowed disabled:bg-slate-400",children:"Upload Selected CSV"}),e.jsx("button",{type:"button",onClick:S,disabled:N||!r,className:"inline-flex items-center justify-center rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition enabled:hover:bg-slate-100 disabled:cursor-not-allowed disabled:text-slate-400",children:"Upload Bundled courses.csv"})]}),e.jsx(b,{className:"mt-3",tone:"danger",message:t}),e.jsx(b,{className:"mt-3",tone:"success",message:a})]})}const qn={name:"",email:"",password:""},Ir={cluster:"",name:"",requirementsText:"",universityName:"",courseCode:"",cutoff:""},lr=r=>{const i={};return String(r||"").split(/\r?\n|;/).map(n=>n.trim()).filter(Boolean).forEach(n=>{const t=n.indexOf(":");if(t<0)return;const s=n.slice(0,t).trim(),a=n.slice(t+1).trim().toUpperCase();!s||!a||(i[s]=a)}),i},cr=r=>{const i=Object.keys(r||{}).length;let n=0,t=0;return Object.values(r||{}).forEach(s=>{Array.isArray(s)&&(n+=s.length,s.forEach(a=>{t+=Array.isArray(a==null?void 0:a.universities)?a.universities.length:0}))}),{clusters:i,courses:n,universities:t}};function Nr({firebaseConfigured:r,onUploadCatalog:i,onAddSingleCourse:n,onLogout:t,onAddRegularAdmin:s,adminProfile:a,adminEmail:I,authError:N,courseCatalog:U}){const[T,l]=o.useState(qn),[O,y]=o.useState(!1),[S,L]=o.useState(""),[d,m]=o.useState(""),[C,Y]=o.useState(Ir),[v,h]=o.useState(!1),[H,J]=o.useState(""),[Q,q]=o.useState(""),_=(a==null?void 0:a.role)==="super",z=o.useMemo(()=>cr(U),[U]),w=(M,G)=>{l(j=>({...j,[M]:G}))},x=(M,G)=>{Y(j=>({...j,[M]:G}))},W=async M=>{if(M.preventDefault(),L(""),m(""),!_){L("Only a super admin can add regular admins.");return}if(!T.email||!T.password){L("Email and password are required.");return}y(!0);try{const G=await s({name:T.name,email:T.email,password:T.password});m(`Regular admin added: ${G.user.email}`),l(qn)}catch(G){L(G.message||"Unable to add regular admin.")}finally{y(!1)}},X=async M=>{if(M.preventDefault(),J(""),q(""),!r){J("Firebase is not configured.");return}const G=Number(C.cluster);if(!Number.isInteger(G)||G<1){J("Cluster must be a whole number greater than 0.");return}const j=String(C.name||"").trim();if(!j){J("Course name is required.");return}const R=String(C.universityName||"").trim();if(!R){J("University name is required.");return}const u=String(C.cutoff||"").trim(),A=u?Number(u):0;if(!Number.isFinite(A)||A<0){J("Cutoff must be a number equal to or greater than 0.");return}h(!0);try{await n({cluster:G,name:j,requirements:lr(C.requirementsText),universities:[{name:R,courseCode:String(C.courseCode||"").trim(),cutoff:A}]}),q(`Saved "${j}" in cluster ${G}.`),Y(p=>({...p,universityName:"",courseCode:"",cutoff:""}))}catch(p){J(p.message||"Unable to save course.")}finally{h(!1)}};return e.jsxs("section",{className:"space-y-6",children:[e.jsxs("div",{className:"relative overflow-hidden rounded-3xl border border-cyan-100 bg-gradient-to-br from-white via-cyan-50 to-emerald-50 p-6 shadow-sm",children:[e.jsx("div",{className:"pointer-events-none absolute -top-14 -right-12 h-44 w-44 rounded-full bg-cyan-200/40 blur-2xl"}),e.jsx("div",{className:"pointer-events-none absolute -bottom-10 -left-10 h-36 w-36 rounded-full bg-emerald-200/50 blur-2xl"}),e.jsxs("div",{className:"relative",children:[e.jsxs("div",{className:"flex flex-wrap items-start justify-between gap-3",children:[e.jsxs("div",{children:[e.jsx("p",{className:"inline-flex rounded-full border border-cyan-200 bg-white/70 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-cyan-700",children:"Control Center"}),e.jsx("h1",{className:"mt-3 text-3xl font-semibold tracking-tight text-slate-900",children:"Admin Dashboard"}),e.jsx("p",{className:"mt-2 max-w-2xl text-sm text-slate-600",children:"Manage admins and maintain course catalog content for calculator results and eligibility checks."}),e.jsxs("p",{className:"mt-3 text-xs font-medium text-slate-500",children:["Signed in as: ",I||"unknown"," (",(a==null?void 0:a.role)||"regular"," admin)"]})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(ln,{to:"/admin/sessions",className:"inline-flex items-center justify-center rounded-xl border border-cyan-300 bg-cyan-50 px-4 py-2 text-sm font-semibold text-cyan-700 transition hover:bg-cyan-100",children:"View Calculated Users"}),e.jsx("button",{type:"button",onClick:t,className:"inline-flex items-center justify-center rounded-xl border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-100",children:"Logout"})]})]}),e.jsxs("div",{className:"mt-5 grid gap-3 sm:grid-cols-3",children:[e.jsxs("div",{className:"rounded-xl border border-slate-200 bg-white/80 p-4",children:[e.jsx("p",{className:"text-xs uppercase tracking-wider text-slate-500",children:"Clusters"}),e.jsx("p",{className:"mt-2 text-2xl font-semibold text-slate-900",children:z.clusters})]}),e.jsxs("div",{className:"rounded-xl border border-slate-200 bg-white/80 p-4",children:[e.jsx("p",{className:"text-xs uppercase tracking-wider text-slate-500",children:"Courses"}),e.jsx("p",{className:"mt-2 text-2xl font-semibold text-slate-900",children:z.courses})]}),e.jsxs("div",{className:"rounded-xl border border-slate-200 bg-white/80 p-4",children:[e.jsx("p",{className:"text-xs uppercase tracking-wider text-slate-500",children:"University Entries"}),e.jsx("p",{className:"mt-2 text-2xl font-semibold text-slate-900",children:z.universities})]})]})]}),e.jsx(b,{className:"mt-3",tone:"danger",message:N})]}),e.jsxs("div",{className:"grid gap-6 xl:grid-cols-2",children:[e.jsxs("div",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsx("h2",{className:"text-xl font-semibold tracking-tight text-slate-900",children:"Admin Users"}),e.jsx("p",{className:"mt-1 text-sm text-slate-600",children:"Create regular admin accounts that can log in and access admin tools."}),_?null:e.jsx(b,{className:"mt-3",tone:"warning",message:"Only a super admin can add regular admin users."}),e.jsxs("form",{onSubmit:W,className:"mt-5 grid gap-4 md:grid-cols-3",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"regular_admin_name",className:"mb-1 block text-sm font-medium text-slate-700",children:"Full Name"}),e.jsx("input",{id:"regular_admin_name",type:"text",value:T.name,onChange:M=>w("name",M.target.value),className:"ui-input",placeholder:"Admin Name"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"regular_admin_email",className:"mb-1 block text-sm font-medium text-slate-700",children:"Email"}),e.jsx("input",{id:"regular_admin_email",type:"email",value:T.email,onChange:M=>w("email",M.target.value),required:!0,className:"ui-input",placeholder:"newadmin@example.com"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"regular_admin_password",className:"mb-1 block text-sm font-medium text-slate-700",children:"Password"}),e.jsx("input",{id:"regular_admin_password",type:"password",value:T.password,onChange:M=>w("password",M.target.value),required:!0,minLength:6,className:"ui-input",placeholder:"At least 6 characters"})]}),e.jsx("div",{className:"md:col-span-3",children:e.jsx("button",{type:"submit",disabled:!_||O,className:"inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-slate-900 to-slate-700 px-4 py-2 text-sm font-semibold text-white transition enabled:hover:from-slate-800 enabled:hover:to-slate-600 disabled:cursor-not-allowed disabled:bg-slate-400",children:O?"Creating...":"Add Regular Admin"})})]}),e.jsx(b,{className:"mt-3",tone:"danger",message:S}),e.jsx(b,{className:"mt-3",tone:"success",message:d})]}),e.jsxs("div",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsx("h2",{className:"text-xl font-semibold tracking-tight text-slate-900",children:"Add Single Course"}),e.jsx("p",{className:"mt-1 text-sm text-slate-600",children:"Add one course entry at a time. If the course already exists in the same cluster, the university entry is merged into it."}),r?null:e.jsx(b,{className:"mt-3",tone:"warning",message:"Firebase is not configured for catalog writes."}),e.jsxs("form",{onSubmit:X,className:"mt-5 grid gap-4 md:grid-cols-2",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"single_course_cluster",className:"mb-1 block text-sm font-medium text-slate-700",children:"Cluster"}),e.jsx("input",{id:"single_course_cluster",type:"number",min:1,value:C.cluster,onChange:M=>x("cluster",M.target.value),required:!0,className:"ui-input",placeholder:"e.g. 2"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"single_course_name",className:"mb-1 block text-sm font-medium text-slate-700",children:"Course Name"}),e.jsx("input",{id:"single_course_name",type:"text",value:C.name,onChange:M=>x("name",M.target.value),required:!0,className:"ui-input",placeholder:"BACHELOR OF COMMERCE"})]}),e.jsxs("div",{className:"md:col-span-2",children:[e.jsx("label",{htmlFor:"single_course_requirements",className:"mb-1 block text-sm font-medium text-slate-700",children:"Minimum Subject Requirements"}),e.jsx("textarea",{id:"single_course_requirements",value:C.requirementsText,onChange:M=>x("requirementsText",M.target.value),rows:4,className:"ui-textarea",placeholder:`Mathematics: C+
English/Kiswahili: B`})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"single_course_university",className:"mb-1 block text-sm font-medium text-slate-700",children:"University"}),e.jsx("input",{id:"single_course_university",type:"text",value:C.universityName,onChange:M=>x("universityName",M.target.value),required:!0,className:"ui-input",placeholder:"University of Nairobi"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"single_course_code",className:"mb-1 block text-sm font-medium text-slate-700",children:"Course Code"}),e.jsx("input",{id:"single_course_code",type:"text",value:C.courseCode,onChange:M=>x("courseCode",M.target.value),className:"ui-input",placeholder:"1263134"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"single_course_cutoff",className:"mb-1 block text-sm font-medium text-slate-700",children:"Cutoff Points"}),e.jsx("input",{id:"single_course_cutoff",type:"number",step:"0.001",min:0,value:C.cutoff,onChange:M=>x("cutoff",M.target.value),className:"ui-input",placeholder:"32.613"})]}),e.jsx("div",{className:"md:col-span-2",children:e.jsx("button",{type:"submit",disabled:v||!r,className:"inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-emerald-600 to-cyan-600 px-4 py-2 text-sm font-semibold text-white transition enabled:hover:from-emerald-500 enabled:hover:to-cyan-500 disabled:cursor-not-allowed disabled:bg-slate-400",children:v?"Saving...":"Save Course Entry"})})]}),e.jsx(b,{className:"mt-3",tone:"danger",message:H}),e.jsx(b,{className:"mt-3",tone:"success",message:Q})]})]}),e.jsx(Er,{firebaseConfigured:r,onUploadCatalog:i,bundledCoursesCsvUrl:ar})]})}const An=20,Ur=["BIO","CHE","MAT","PHY"],dn={code:"",email:"",phoneNumber:"",amountPaid:"0",medicineEligible:!1},Ar=r=>{if(!r)return"Unknown";const i=Date.parse(r);return Number.isFinite(i)?new Date(i).toLocaleString():"Unknown"},Kn=r=>{const i=Number(r);return Number.isFinite(i)?i.toFixed(3):"0.000"},ee=r=>{const i=r&&typeof r=="object"?r:{};return Array.from({length:20},(n,t)=>{const s=t+1;return{cluster:s,score:Number(i[s]??i[String(s)]??0)}}).map(n=>({...n,score:Number.isFinite(n.score)?n.score:0}))},Tr=(r,i=3)=>ee(r).sort((n,t)=>t.score-n.score||n.cluster-t.cluster).slice(0,i),yr=r=>[r.code,r.email,r.phoneNumber,r.amountPaid,r.createdAt,r.medicineEligible?"eligible":"not-eligible"].join(" ").toLowerCase(),Cr=(r,i)=>{if(i<=7)return Array.from({length:i},(t,s)=>s+1);const n=Math.max(1,Math.min(r-3,i-6));return Array.from({length:7},(t,s)=>n+s)};function Sr({firebaseConfigured:r}){const[i,n]=o.useState([]),[t,s]=o.useState(!0),[a,I]=o.useState(""),[N,U]=o.useState(""),[T,l]=o.useState(""),[O,y]=o.useState(""),[S,L]=o.useState(""),[d,m]=o.useState([]),[C,Y]=o.useState(1),[v,h]=o.useState(dn),[H,J]=o.useState(!1),[Q,q]=o.useState(!1),[_,z]=o.useState(""),w=o.useCallback(async()=>{if(!r){s(!1),I("Firebase is not configured."),n([]);return}s(!0),I("");try{const c=await qe();n(c)}catch(c){I(c.message||"Unable to load cluster sessions."),n([])}finally{s(!1)}},[r]);o.useEffect(()=>{w().catch(()=>{})},[w]);const x=o.useMemo(()=>{const c=String(O||"").trim().toLowerCase();return c?i.filter(g=>yr(g).includes(c)):i},[O,i]),W=o.useMemo(()=>Math.max(1,Math.ceil(x.length/An)),[x.length]),X=o.useMemo(()=>{const c=(C-1)*An;return x.slice(c,c+An)},[C,x]);o.useMemo(()=>{const c=new Set(x.map(f=>f.email||f.phoneNumber||f.code)).size,g=x.filter(f=>f.medicineEligible).length;return{totalSessions:x.length,uniqueUsers:c,medicineQualifiedCount:g}},[x]);const M=o.useMemo(()=>new Set(d),[d]),G=o.useMemo(()=>X.map(c=>c.code),[X]),j=G.length>0&&G.every(c=>M.has(c));o.useEffect(()=>{Y(1)},[O]),o.useEffect(()=>{C>W&&Y(W)},[C,W]),o.useEffect(()=>{const c=new Set(x.map(g=>g.code));m(g=>g.filter(f=>c.has(f))),S&&!c.has(S)&&L(""),v.code&&!c.has(v.code)&&h(dn)},[v.code,S,x]);const R=c=>{m(g=>{const f=new Set(g);return f.has(c)?f.delete(c):f.add(c),Array.from(f)})},u=()=>{m(c=>{const g=new Set(c);return j?G.forEach(f=>g.delete(f)):G.forEach(f=>g.add(f)),Array.from(g)})},A=()=>{H||h(dn)},p=async c=>{if(c.preventDefault(),!v.code)return;U(""),l("");const g=Number(v.amountPaid);if(!Number.isFinite(g)||g<0){U("Amount paid must be a valid number equal to or greater than 0.");return}J(!0);try{await $e(v.code,{email:v.email,phoneNumber:v.phoneNumber,amountPaid:g,medicineEligible:v.medicineEligible}),l(`Session ${v.code} updated successfully.`),h(dn),await w()}catch(f){U(f.message||"Unable to update session.")}finally{J(!1)}},Z=async c=>{if(c&&(U(""),l(""),!!window.confirm(`Delete session ${c}?`))){z(c);try{await _e(c),l(`Session ${c} deleted.`),m(g=>g.filter(f=>f!==c)),S===c&&L(""),await w()}catch(g){U(g.message||"Unable to delete session.")}finally{z("")}}},an=async()=>{if(d.length&&(U(""),l(""),!!window.confirm(`Delete ${d.length} selected session(s)?`))){q(!0);try{const c=await We(d);l(`${c} session(s) deleted.`),m([]),S&&d.includes(S)&&L(""),await w()}catch(c){U(c.message||"Unable to delete selected sessions.")}finally{q(!1)}}},nn=o.useMemo(()=>Cr(C,W),[C,W]),Nn=x.length?(C-1)*An+1:0,In=Math.min(x.length,C*An);return e.jsxs("section",{className:"space-y-6",children:[e.jsx("div",{className:"rounded-3xl border border-cyan-100 bg-gradient-to-br from-white via-cyan-50 to-emerald-50 p-6 shadow-sm",children:e.jsxs("div",{className:"flex flex-wrap items-start justify-between gap-3",children:[e.jsxs("div",{children:[e.jsx("p",{className:"inline-flex rounded-full border border-cyan-200 bg-white/70 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-cyan-700",children:"Admin Analytics"}),e.jsx("h1",{className:"mt-3 text-3xl font-semibold tracking-tight text-slate-900",children:"Calculated Users Table"}),e.jsx("p",{className:"mt-2 text-sm text-slate-600",children:"Review users who calculated cluster points and manage records safely."})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsxs("button",{type:"button",onClick:()=>w(),className:"inline-flex items-center justify-center gap-1.5 rounded-xl border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-100",children:[e.jsx(ie,{className:"h-4 w-4"}),"Refresh"]}),e.jsxs(ln,{to:"/admin",className:"inline-flex items-center justify-center gap-1.5 rounded-xl bg-gradient-to-r from-slate-900 to-slate-700 px-4 py-2 text-sm font-semibold text-white transition hover:from-slate-800 hover:to-slate-600",children:[e.jsx(te,{className:"h-4 w-4"}),"Back to Admin"]})]})]})}),e.jsxs("div",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsxs("div",{className:"flex flex-wrap items-center justify-between gap-3",children:[e.jsx("h2",{className:"text-xl font-semibold tracking-tight text-slate-900",children:"User Calculations"}),e.jsxs("div",{className:"flex w-full flex-wrap items-center justify-end gap-2 lg:w-auto",children:[e.jsx("input",{type:"search",value:O,onChange:c=>y(c.target.value),placeholder:"Search by email, code, phone...",className:"ui-input w-full max-w-sm"}),e.jsxs("button",{type:"button",onClick:u,disabled:!G.length,className:"inline-flex items-center justify-center gap-1.5 rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm font-semibold text-slate-700 transition enabled:hover:bg-slate-100 disabled:cursor-not-allowed disabled:text-slate-400",children:[j?e.jsx(se,{className:"h-4 w-4"}):e.jsx(Fn,{className:"h-4 w-4"}),j?"Unselect Page":"Select Page"]}),e.jsxs("button",{type:"button",onClick:an,disabled:!d.length||Q,className:"inline-flex items-center justify-center gap-1.5 rounded-xl bg-rose-600 px-3 py-2 text-sm font-semibold text-white transition enabled:hover:bg-rose-500 disabled:cursor-not-allowed disabled:bg-slate-400",children:[e.jsx(Bn,{className:"h-4 w-4"}),Q?"Deleting...":`Delete Selected (${d.length})`]})]})]}),e.jsx(b,{className:"mt-3",tone:"danger",message:a}),e.jsx(b,{className:"mt-3",tone:"danger",message:N}),e.jsx(b,{className:"mt-3",tone:"success",message:T}),t?e.jsx(b,{className:"mt-3",tone:"info",message:"Loading sessions..."}):null,e.jsx("div",{className:"mt-4 overflow-x-auto",children:e.jsxs("table",{className:"min-w-full divide-y divide-slate-200 text-sm",children:[e.jsx("thead",{className:"bg-slate-50 text-left text-xs uppercase tracking-wider text-slate-500",children:e.jsxs("tr",{children:[e.jsx("th",{className:"px-3 py-3 font-semibold",children:e.jsx("input",{type:"checkbox",checked:j,onChange:u,"aria-label":"Select all on current page",className:"ui-checkbox"})}),e.jsx("th",{className:"px-3 py-3 font-semibold",children:"Date"}),e.jsx("th",{className:"px-3 py-3 font-semibold",children:"Access Code"}),e.jsx("th",{className:"px-3 py-3 font-semibold",children:"User"}),e.jsx("th",{className:"px-3 py-3 font-semibold",children:"Best Cluster"}),e.jsx("th",{className:"px-3 py-3 font-semibold",children:"Top 3 Cluster Points"}),e.jsx("th",{className:"px-3 py-3 font-semibold",children:"Actions"})]})}),e.jsxs("tbody",{className:"divide-y divide-slate-200 bg-white text-slate-700",children:[!t&&!X.length?e.jsx("tr",{children:e.jsx("td",{colSpan:8,className:"px-3 py-8 text-center text-sm text-slate-500",children:"No calculation sessions found."})}):null,X.map(c=>{const g=Tr(c.results),f=g[0],$=Object.entries(c.grades||{}).filter(([,D])=>D),Un=_===c.code;return e.jsxs(o.Fragment,{children:[e.jsxs("tr",{children:[e.jsx("td",{className:"whitespace-nowrap px-3 py-3",children:e.jsx("input",{type:"checkbox",checked:M.has(c.code),onChange:()=>R(c.code),"aria-label":`Select ${c.code}`,className:"ui-checkbox"})}),e.jsx("td",{className:"whitespace-nowrap px-3 py-3",children:Ar(c.createdAt)}),e.jsx("td",{className:"whitespace-nowrap px-3 py-3 font-mono font-semibold text-slate-900",children:c.code}),e.jsxs("td",{className:"px-3 py-3",children:[e.jsx("p",{className:"font-medium text-slate-900",children:c.email||"No email"}),e.jsx("p",{className:"text-xs text-slate-500",children:c.phoneNumber||"No phone"})]}),e.jsx("td",{className:"whitespace-nowrap px-3 py-3",children:f?`C${f.cluster}: ${Kn(f.score)}`:"N/A"}),e.jsx("td",{className:"px-3 py-3",children:e.jsx("div",{className:"flex flex-wrap gap-1.5",children:g.map(D=>e.jsxs("span",{className:"rounded-full border border-slate-200 bg-slate-50 px-2 py-1 text-xs font-medium text-slate-700",children:["C",D.cluster,": ",Kn(D.score)]},`${c.code}-${D.cluster}`))})}),e.jsx("td",{className:"whitespace-nowrap px-3 py-3",children:e.jsxs("div",{className:"flex items-center gap-1.5",children:[e.jsxs("button",{type:"button",onClick:()=>L(D=>D===c.code?"":c.code),className:"inline-flex items-center justify-center gap-1 rounded-lg border border-slate-300 bg-white px-2.5 py-1.5 text-xs font-semibold text-slate-700 transition hover:bg-slate-100",children:[S===c.code?e.jsx(ae,{className:"h-3.5 w-3.5"}):e.jsx(oe,{className:"h-3.5 w-3.5"}),S===c.code?"Hide":"View"]}),e.jsxs("button",{type:"button",onClick:()=>Z(c.code),disabled:Un,className:"inline-flex items-center justify-center gap-1 rounded-lg border border-rose-300 bg-rose-50 px-2.5 py-1.5 text-xs font-semibold text-rose-700 transition enabled:hover:bg-rose-100 disabled:cursor-not-allowed disabled:text-rose-400",children:[e.jsx(Bn,{className:"h-3.5 w-3.5"}),Un?"Deleting...":"Delete"]})]})})]}),S===c.code?e.jsx("tr",{className:"bg-slate-50/70",children:e.jsx("td",{colSpan:8,className:"px-3 py-4",children:e.jsxs("div",{className:"grid gap-4 lg:grid-cols-3",children:[e.jsxs("div",{className:"rounded-xl border border-slate-200 bg-white p-3",children:[e.jsx("h3",{className:"text-sm font-semibold text-slate-900",children:"Qualification Details"}),e.jsx("p",{className:"mt-2 text-xs text-slate-600",children:"Medicine core subjects (BIO, CHE, MAT, PHY):"}),e.jsx("div",{className:"mt-2 flex flex-wrap gap-1.5",children:Ur.map(D=>{var Sn,Hn;return e.jsxs("span",{className:`rounded-full border px-2 py-1 text-xs font-medium ${(Sn=c.grades)!=null&&Sn[D]?"border-emerald-200 bg-emerald-50 text-emerald-700":"border-rose-200 bg-rose-50 text-rose-700"}`,children:[D,": ",((Hn=c.grades)==null?void 0:Hn[D])||"Missing"]},`${c.code}-${D}`)})}),e.jsxs("p",{className:"mt-3 text-xs text-slate-500",children:["Amount Paid: KES ",c.amountPaid||0]})]}),e.jsxs("div",{className:"rounded-xl border border-slate-200 bg-white p-3 lg:col-span-2",children:[e.jsx("h3",{className:"text-sm font-semibold text-slate-900",children:"All Cluster Points"}),e.jsx("div",{className:"mt-2 grid grid-cols-2 gap-2 sm:grid-cols-4 lg:grid-cols-5",children:ee(c.results).map(D=>e.jsxs("div",{className:"rounded-lg border border-slate-200 bg-slate-50 px-2 py-2 text-xs",children:[e.jsxs("p",{className:"font-semibold text-slate-700",children:["Cluster ",D.cluster]}),e.jsx("p",{className:"mt-1 font-mono text-slate-900",children:Kn(D.score)})]},`${c.code}-cluster-${D.cluster}`))}),e.jsxs("p",{className:"mt-3 text-xs text-slate-500",children:["Graded subjects: ",$.length," ",$.length?`(${$.map(([D,Sn])=>`${D}:${Sn}`).join(", ")})`:""]})]})]})})}):null]},c.code)})]})]})}),e.jsxs("div",{className:"mt-4 flex flex-wrap items-center justify-between gap-3",children:[e.jsxs("p",{className:"text-sm text-slate-600",children:["Showing ",Nn,"-",In," of ",x.length]}),e.jsxs("div",{className:"flex items-center gap-1.5",children:[e.jsxs("button",{type:"button",onClick:()=>Y(c=>Math.max(1,c-1)),disabled:C<=1,className:"inline-flex items-center justify-center gap-1 rounded-lg border border-slate-300 bg-white px-3 py-1.5 text-sm font-semibold text-slate-700 transition enabled:hover:bg-slate-100 disabled:cursor-not-allowed disabled:text-slate-400",children:[e.jsx(Ee,{className:"h-4 w-4"}),"Prev"]}),nn.map(c=>e.jsx("button",{type:"button",onClick:()=>Y(c),className:`inline-flex items-center justify-center rounded-lg border px-3 py-1.5 text-sm font-semibold transition ${c===C?"border-slate-900 bg-slate-900 text-white":"border-slate-300 bg-white text-slate-700 hover:bg-slate-100"}`,children:c},`page-${c}`)),e.jsxs("button",{type:"button",onClick:()=>Y(c=>Math.min(W,c+1)),disabled:C>=W,className:"inline-flex items-center justify-center gap-1 rounded-lg border border-slate-300 bg-white px-3 py-1.5 text-sm font-semibold text-slate-700 transition enabled:hover:bg-slate-100 disabled:cursor-not-allowed disabled:text-slate-400",children:["Next",e.jsx(Ie,{className:"h-4 w-4"})]})]})]})]}),v.code?e.jsx("div",{className:"fixed inset-0 z-40 flex items-center justify-center bg-slate-900/40 p-4",children:e.jsxs("div",{className:"w-full max-w-lg rounded-2xl border border-slate-200 bg-white p-6 shadow-xl",children:[e.jsxs("h3",{className:"text-lg font-semibold text-slate-900",children:["Edit Session ",v.code]}),e.jsx("p",{className:"mt-1 text-sm text-slate-600",children:"Update user contact details, payment amount, and qualification flag."}),e.jsxs("form",{onSubmit:p,className:"mt-4 grid gap-4",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"edit_session_email",className:"mb-1 block text-sm font-medium text-slate-700",children:"Email"}),e.jsx("input",{id:"edit_session_email",type:"email",value:v.email,onChange:c=>h(g=>({...g,email:c.target.value})),className:"ui-input"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"edit_session_phone",className:"mb-1 block text-sm font-medium text-slate-700",children:"Phone Number"}),e.jsx("input",{id:"edit_session_phone",type:"text",value:v.phoneNumber,onChange:c=>h(g=>({...g,phoneNumber:c.target.value})),className:"ui-input"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"edit_session_amount",className:"mb-1 block text-sm font-medium text-slate-700",children:"Amount Paid"}),e.jsx("input",{id:"edit_session_amount",type:"number",min:0,step:"0.01",value:v.amountPaid,onChange:c=>h(g=>({...g,amountPaid:c.target.value})),className:"ui-input"})]}),e.jsxs("label",{className:"inline-flex items-center gap-2 text-sm font-medium text-slate-700",children:[e.jsx("input",{type:"checkbox",checked:v.medicineEligible,onChange:c=>h(g=>({...g,medicineEligible:c.target.checked})),className:"ui-checkbox"}),"Medicine Eligible"]}),e.jsxs("div",{className:"mt-2 flex items-center justify-end gap-2",children:[e.jsxs("button",{type:"button",onClick:A,disabled:H,className:"inline-flex items-center justify-center gap-1.5 rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition enabled:hover:bg-slate-100 disabled:cursor-not-allowed disabled:text-slate-400",children:[e.jsx(le,{className:"h-4 w-4"}),"Cancel"]}),e.jsxs("button",{type:"submit",disabled:H,className:"inline-flex items-center justify-center gap-1.5 rounded-lg bg-cyan-600 px-4 py-2 text-sm font-semibold text-white transition enabled:hover:bg-cyan-500 disabled:cursor-not-allowed disabled:bg-slate-400",children:[e.jsx(Fn,{className:"h-4 w-4"}),H?"Saving...":"Save Changes"]})]})]})]})}):null]})}const yn={darajaPayment:k("/api/payments"),darajaQuery:k("/api/payments/query"),email:k("/sendEmail"),calculateCluster:k("/calculateClusterPoints"),adminHealth:k("/api/admin/health")},Rr=async r=>{try{const i=await r.text();return i?JSON.parse(i):null}catch{return null}},vn=async({url:r,headers:i,body:n})=>{const t=await fetch(r,{method:"POST",credentials:"include",headers:i||{},body:n||void 0}),s=await Rr(t);return{ok:t.ok,status:t.status,data:s}},Yn=(r,i)=>{const n=(r==null?void 0:r.data)||{},t=(n==null?void 0:n.error)||(n==null?void 0:n.message)||(n==null?void 0:n.errorMessage)||(n==null?void 0:n.ResultDesc);return t?String(t):i},Mn=r=>r&&typeof r=="object"&&"data"in r&&r.success!==!1?r.data:r,ur=r=>({source:"local-engine",results:Ve(r),medicineEligible:Me(r)}),Or=async r=>{const i=(r==null?void 0:r["phone number"])||(r==null?void 0:r.phone_number)||(r==null?void 0:r.phoneNumber)||(r==null?void 0:r.phone)||"",n=Number((r==null?void 0:r.amount)??0),t=await vn({url:yn.darajaPayment,headers:{"Content-Type":"application/json"},body:JSON.stringify({phone_number:i,amount:n,account_reference:String((r==null?void 0:r.account_reference)||(r==null?void 0:r.accountReference)||"KUCCPS-CLUSTER"),transaction_description:String((r==null?void 0:r.transaction_description)||(r==null?void 0:r.transactionDesc)||"Cluster payment")})});if(!t.ok)throw new Error(Yn(t,"Unable to initiate STK push."));return Mn(t.data)},$n=async r=>{const i=String((r==null?void 0:r.email)||"").trim(),n=String((r==null?void 0:r.subject)||"").trim(),t=String((r==null?void 0:r.message)||"");if(!i||!n||!t)throw new Error("Email, subject and message are required.");const s=new URLSearchParams({email:i,subject:n,message:t}).toString(),a=[{url:yn.email,headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,subject:n,message:t})},{url:yn.email,headers:{"Content-Type":"application/x-www-form-urlencoded"},body:s}],I=[],N=[];for(const T of a){const l=await vn(T);if(l.ok)return Mn(l.data);I.push(l.status),N.push(Yn(l,`HTTP ${l.status}`))}const U=N.filter(Boolean).join(" | ");throw new Error(`Email API request failed. ${U||`Status codes: ${I.join(", ")}.`}`)},dr=async({checkoutRequestId:r})=>{const i={checkoutRequestId:String(r||"").trim()};if(!i.checkoutRequestId)throw new Error("checkoutRequestId is required.");const n=await vn({url:yn.darajaQuery,headers:{"Content-Type":"application/json"},body:JSON.stringify(i)});if(n.ok)return Mn(n.data);throw new Error(Yn(n,"Unable to fetch payment status."))},_n=r=>new Promise(i=>window.setTimeout(i,r)),mr=async({checkoutRequestId:r,timeoutMs:i=3e5,intervalMs:n=3e3,onStatus:t})=>{var I;const s=Date.now();let a="";for(;Date.now()-s<=i;){let N;try{N=await dr({checkoutRequestId:r})}catch(l){a=String((l==null?void 0:l.message)||"").trim()||a,t==null||t({status:"pending",transientError:!0,resultDesc:a||"Temporary payment status check issue."}),await _n(n);continue}t==null||t(N);const U=String((N==null?void 0:N.status)||"").trim().toLowerCase(),T=Number(((I=N==null?void 0:N.queryResponse)==null?void 0:I.ResultCode)??NaN);if(U==="success"||T===0)return N;if(U==="failed")throw new Error((N==null?void 0:N.resultDesc)||"Payment failed. Please try again.");await _n(n)}throw new Error(a?`Timed out while waiting for M-Pesa confirmation. Last status: ${a}`:"Timed out while waiting for M-Pesa confirmation.")},hr=async({grades:r,checkoutRequestId:i,merchantRequestId:n})=>{const t={grades:r||{},checkoutRequestId:String(i||"").trim(),merchantRequestId:String(n||"").trim()};if(!t.checkoutRequestId&&!t.merchantRequestId)throw new Error("checkoutRequestId or merchantRequestId is required before calculation.");const s=await vn({url:yn.calculateCluster,headers:{"Content-Type":"application/json"},body:JSON.stringify(t)});if(s.ok)return Mn(s.data);throw new Error(Yn(s,"Unable to calculate cluster points after payment."))},gr=r=>r==="saved-session"?"Saved Session":r==="firebase-function"?"Firebase Function":"Local Cluster Engine",vr=r=>Number(r||0).toFixed(3).replace(/\.?0+$/,""),Yr=(r,i)=>{const n=Object.entries(r||{}).map(([t,s])=>[t,Number(s)]).filter(([,t])=>Number.isFinite(t)&&t>0).sort((t,s)=>s[1]-t[1]).slice(0,i);return n.length?["Top cluster points:",...n.map(([t,s],a)=>`${a+1}. Cluster ${t}: ${vr(s)}`)]:[]},Mr=({code:r,results:i,medicineEligible:n})=>{const t=["Your KUCCPS cluster calculation is ready.","",`Access code: ${r}`];return i&&Object.keys(i).length>0&&t.push("",...Yr(i,3)),typeof n=="boolean"&&t.push("",`Medicine eligibility: ${n?"Eligible":"Not eligible"}.`),t.push("","Use this code on the home page to open your saved cluster points and continue course selection."),t.join(`
...
`),Vr=/^[^\s@]+@[^\s@]+\.[^\s@]+$/,Kr=r=>Vr.test(String(r||"").trim()),Lr=r=>{const i=String(r||"").replace(/\D/g,"");return i.length===10&&i.startsWith("0")?`254${i.slice(1)}`:i.length===9&&i.startsWith("7")?`254${i}`:i.length===12&&i.startsWith("254")?i:null},Wn=()=>Object.fromEntries(Object.keys(xn).map(r=>[r,""])),br="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm transition hover:shadow",xr="mt-3 inline-flex w-full items-center justify-between rounded-lg border border-slate-300 bg-slate-50 px-3 py-2 text-sm font-medium text-slate-700 transition hover:bg-slate-100",pr="ui-select";function Gr({onCalculationReady:r,payableAmount:i,gradeOptions:n}){const t=mn(),[s,a]=o.useState(Wn()),[I,N]=o.useState(Object.fromEntries(jn.map((R,u)=>[R.title,u===0]))),[U,T]=o.useState(!1),[l,O]=o.useState(""),[y,S]=o.useState(""),[L,d]=o.useState(""),[m,C]=o.useState(null),[Y,v]=o.useState(""),[h,H]=o.useState(""),[J,Q]=o.useState(""),[q,_]=o.useState(!1),[z,w]=o.useState(""),x=(R,u)=>{a(A=>({...A,[R]:u}))},W=R=>xn[R]||R,X=()=>Object.entries(s).filter(([,R])=>R&&R!=="").map(([R])=>R),M=R=>{N(u=>{const A=Object.fromEntries(Object.keys(u).map(p=>[p,!1]));return A[R]=!u[R],A})},G=async R=>{R.preventDefault(),w(""),S(""),d("");const u=X();if(u.length<7){w("Select grades for at least 7 subjects across all groups to compute cluster points.");return}const A=Wn();u.forEach(Z=>{A[Z]=s[Z]});const p=String(h||"").trim();if(!Kr(p)){w("Enter a valid email address.");return}C(A),v(p);try{_(!0),p&&p!==J&&(await $n({email:p,subject:"KUCCPS Cluster Calculator: Email received",message:fr({payableAmount:i})}),Q(p))}catch(Z){const an=Z instanceof Error?Z.message:"";w(an?`Unable to send confirmation email (${an}). Please verify your email and try again.`:"Unable to send confirmation email. Please verify your email and try again.");return}finally{_(!1)}T(!0)},j=async R=>{if(R.preventDefault(),S(""),d(""),!m){S("Please submit your grades and email first.");return}if(!Y){S("Enter a valid email before continuing.");return}const u=Lr(l);if(!u){S("Enter a valid M-Pesa phone number e.g. 0712345678 or 254712345678.");return}_(!0);try{d("Sending the STK push to your phone...");const A=await Or({amount:i,phone_number:u,phone:u,phoneNumber:u,"phone number":u}),p=String((A==null?void 0:A.CheckoutRequestID)||(A==null?void 0:A.checkoutRequestId)||"").trim(),Z=String((A==null?void 0:A.MerchantRequestID)||(A==null?void 0:A.merchantRequestId)||"").trim();if(!p&&!Z)throw new Error("STK push response did not include a payment reference.");d("STK push sent. Complete the payment on your phone. Waiting for confirmation...");const an=await mr({checkoutRequestId:p,merchantRequestId:Z,onStatus:$=>{($==null?void 0:$.status)==="pending"&&d("Waiting for M-Pesa confirmation. Complete the prompt on your phone to continue.")}});d("Payment confirmed. Calculating cluster points...");let nn,Nn="";try{nn=await hr({grades:m,checkoutRequestId:p,merchantRequestId:Z})}catch($){nn=ur(m),Nn=String(($==null?void 0:$.message)||"").trim()||"Backend calculation API was unavailable, so a local verified fallback was used."}const{session:In,storage:c,warning:g}=await ke({email:Y,phoneNumber:u,amountPaid:i,grades:m,results:nn.results,medicineEligible:nn.medicineEligible,paymentResponse:{initiation:A,confirmation:an}}),f=["Payment confirmed."];Nn&&f.push(`Cluster points calculated locally (${Nn}).`),c==="local"?f.push(g||"Firebase save failed. Session was saved on this browser only, so code restore works only on this device."):f.push("Session saved to Firebase.");try{await $n({email:Y,subject:"KUCCPS Cluster Calculator Results",message:Mr({code:In.code,results:nn.results,medicineEligible:nn.medicineEligible})}),f.push(`Results email sent to ${Y}.`)}catch($){const Un=$ instanceof Error?$.message:"";f.push(Un?`Email delivery failed (${Un}). Save this code: ${In.code}.`:`Email delivery failed. Save this code: ${In.code}.`)}r({grades:m,results:nn.results,source:nn.source,accessCode:In.code,sessionMessage:f.join(" ")}),T(!1),S(""),d(""),w(""),t("/results")}catch(A){const p=A instanceof Error?A.message:"Payment or calculation failed.";S(p),w(p),d("")}finally{_(!1)}};return e.jsxs("section",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsx("h1",{className:"text-2xl font-semibold tracking-tight",children:"Cluster Points Calculator"}),e.jsx("p",{className:"mt-2 text-sm text-slate-600",children:"Enter your grades and email, then start payment. Cluster points are only shown after the M-Pesa payment is confirmed."}),e.jsxs("p",{className:"mt-1 text-sm font-medium text-emerald-700",children:["Amount: KES ",i]}),e.jsxs("form",{onSubmit:G,className:"mt-6 space-y-6",children:[e.jsx(b,{tone:"danger",message:z}),e.jsx("div",{className:"grid gap-5 xl:grid-cols-2",children:jn.map(R=>e.jsxs("article",{className:br,children:[e.jsx("div",{className:"flex items-start justify-between gap-3",children:e.jsxs("div",{children:[e.jsx("h2",{className:"text-base font-semibold text-slate-900",children:R.title}),e.jsx("p",{className:"mt-1 text-xs text-slate-500",children:R.required?"Core group. Enter grades for all listed subjects.":"Optional group. Fill available subjects."})]})}),e.jsxs("button",{type:"button",onClick:()=>M(R.title),className:xr,children:[e.jsx("span",{children:I[R.title]?"Hide grade fields":"Show grade fields"}),e.jsx(ce,{className:`h-4 w-4 text-slate-500 transition-transform ${I[R.title]?"rotate-180":"rotate-0"}`})]}),I[R.title]?e.jsx("div",{className:"mt-4 grid gap-3 sm:grid-cols-2",children:R.subjects.map(u=>e.jsxs("div",{children:[e.jsxs("label",{htmlFor:`${R.title}-${u}`,className:"mb-1 block text-sm font-medium text-slate-700",children:[W(u),R.required?e.jsx("span",{className:"text-rose-600",children:" *"}):null]}),e.jsxs("select",{id:`${R.title}-${u}`,value:s[u],onChange:A=>x(u,A.target.value),required:R.required,className:pr,children:[e.jsx("option",{value:"",children:"Select grade"}),n.map(A=>e.jsx("option",{value:A,children:A},A))]})]},u))}):null]},R.title))}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"email",className:"mb-1 block text-sm font-medium text-slate-700",children:"Email Address (for access code)"}),e.jsx("input",{id:"email",type:"email",value:h,onChange:R=>H(R.target.value),placeholder:"you@example.com",required:!0,className:"ui-input"})]}),e.jsx("button",{type:"submit",disabled:q,className:"inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-slate-900 to-slate-700 px-4 py-2 text-sm font-semibold text-white transition hover:from-slate-800 hover:to-slate-700",children:q?"Processing...":"Calculate Cluster Points"})]}),U?e.jsx("div",{className:"fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 px-4",children:e.jsxs("div",{className:"w-full max-w-md rounded-2xl border border-slate-200 bg-white p-6 shadow-xl",children:[e.jsx("h2",{className:"text-lg font-semibold text-slate-900",children:"Enter M-Pesa Phone Number"}),e.jsxs("p",{className:"mt-1 text-sm text-slate-600",children:["We will send an STK push for KES ",i,". Your cluster points remain locked until the payment is confirmed."]}),e.jsxs("form",{onSubmit:j,className:"mt-4 space-y-4",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"dialog_phone_number",className:"mb-1 block text-sm font-medium text-slate-700",children:"M-Pesa Phone Number"}),e.jsx("input",{id:"dialog_phone_number",type:"tel",value:l,onChange:R=>O(R.target.value),placeholder:"0712345678",autoFocus:!0,required:!0,className:"ui-input"})]}),e.jsx(b,{tone:"info",message:L}),e.jsx(b,{tone:"danger",message:y}),e.jsxs("div",{className:"flex items-center justify-end gap-3",children:[e.jsx("button",{type:"button",onClick:()=>{q||(T(!1),S(""))},disabled:q,className:"inline-flex items-center justify-center rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-100 disabled:cursor-not-allowed disabled:opacity-60",children:"Cancel"}),e.jsx("button",{type:"submit",disabled:q,className:"inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-slate-900 to-slate-700 px-4 py-2 text-sm font-semibold text-white transition enabled:hover:from-slate-800 enabled:hover:to-slate-700 disabled:cursor-not-allowed disabled:bg-slate-400",children:q?"Processing...":"Send STK Push"})]})]})]})}):null]})}const Ln={A:12,"A-":11,"B+":10,B:9,"B-":8,"C+":7,C:6,"C-":5,"D+":4,D:3,"D-":2,E:1},Hr={ENGLISH:"ENG",KISWAHILI:"KIS",MATHEMATICS:"MAT",MATH:"MAT",BIOLOGY:"BIO",CHEMISTRY:"CHE",PHYSICS:"PHY","GENERAL SCIENCE":"GSC",HISTORY:"HAG","HISTORY & GOVERNMENT":"HAG",GEOGRAPHY:"GEO",CRE:"CRE",IRE:"IRE",HRE:"HRE","COMPUTER STUDIES":"CMP",AGRICULTURE:"AGR","ART & DESIGN":"ARD","HOME SCIENCE":"HSC","BUSINESS STUDIES":"BST",FRENCH:"FRE",GERMAN:"GER",MUSIC:"MUS",ARABIC:"ARB"},Fr=(r,i)=>{const n=[];for(const[t,s]of Object.entries(i||{})){const a=String(s||"").trim().toUpperCase();if(!(a in Ln))continue;const I=String(t).split("/").map(l=>{const O=l.trim().toUpperCase();return Hr[O]||O});let N=!1,U=null,T=null;for(const l of I){const O=(r[l]||"").toUpperCase();if(O){if((Ln[O]||0)>=Ln[a]){N=!0;break}U=l,T=O}}N||n.push({subject:t,required:a,studentSubject:U,studentGrade:T})}return{passed:n.length===0,failed:n}};function Br({results:r,grades:i,courseCatalog:n}){const[t]=Ne(),s=Number(t.get("cluster")||0),a=t.get("course")||"";if(!r||!i)return e.jsx(on,{to:"/",replace:!0});if(!s||!a)return e.jsx(on,{to:"/results",replace:!0});const N=(n[s]||[]).find(y=>y.name===a);if(!N)return e.jsx(on,{to:"/results",replace:!0});const U=Number(r[s]??r[String(s)]??0),T=Fr(i,N.requirements),l=[],O=y=>Number(y||0).toFixed(3).replace(/\.?0+$/,"");if(T.passed)for(const y of N.universities||[])U>=Number(y.cutoff)&&l.push(y);return e.jsxs("section",{className:"space-y-6",children:[e.jsxs("div",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsx("h1",{className:"text-2xl font-semibold tracking-tight",children:a}),e.jsxs("div",{className:"mt-3 flex flex-wrap gap-4 text-sm text-slate-700",children:[e.jsxs("p",{children:[e.jsx("span",{className:"font-semibold text-slate-900",children:"Cluster:"})," ",s]}),e.jsxs("p",{children:[e.jsx("span",{className:"font-semibold text-slate-900",children:"Cluster Points:"})," ",U]})]})]}),T.passed?l.length?e.jsxs("article",{className:"rounded-2xl border border-emerald-200 bg-white p-5 shadow-sm",children:[e.jsx("h2",{className:"text-lg font-semibold text-emerald-900",children:"Qualified Universities"}),e.jsxs("p",{className:"mt-1 text-sm text-slate-600",children:["You qualify for ",l.length," ",l.length===1?"university":"universities"," based on your cluster points."]}),e.jsx("div",{className:"mt-4 overflow-x-auto rounded-xl border border-emerald-100",children:e.jsxs("table",{className:"min-w-full divide-y divide-emerald-100 text-sm",children:[e.jsx("thead",{className:"bg-emerald-50 text-left text-emerald-900",children:e.jsxs("tr",{children:[e.jsx("th",{className:"px-3 py-2 font-semibold",children:"University"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Cutoff"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Your Points"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Margin"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Status"})]})}),e.jsx("tbody",{className:"divide-y divide-emerald-50 bg-white text-slate-700",children:l.slice().sort((y,S)=>Number(S.cutoff)-Number(y.cutoff)).map(y=>e.jsxs("tr",{className:"hover:bg-emerald-50/40",children:[e.jsx("td",{className:"px-3 py-2 font-medium text-slate-900",children:y.name}),e.jsx("td",{className:"px-3 py-2",children:O(y.cutoff)}),e.jsx("td",{className:"px-3 py-2",children:O(U)}),e.jsxs("td",{className:"px-3 py-2 text-emerald-700",children:["+",O(U-Number(y.cutoff))]}),e.jsx("td",{className:"px-3 py-2",children:e.jsx("span",{className:"rounded-full border border-emerald-200 bg-emerald-50 px-2 py-1 text-xs font-semibold text-emerald-800",children:"Qualified"})})]},`${y.name}-${y.cutoff}`))})]})})]}):e.jsxs("article",{className:"rounded-2xl border border-amber-200 bg-amber-50 p-5",children:[e.jsx("h2",{className:"text-lg font-semibold text-amber-900",children:"Not Qualified for Any University"}),e.jsx("p",{className:"mt-2 text-sm text-amber-900",children:"Based on your current cluster points, you do not qualify for any listed university for this course."})]}):e.jsxs("div",{className:"space-y-4",children:[e.jsxs("article",{className:"rounded-2xl border border-amber-200 bg-amber-50 p-5",children:[e.jsx("h2",{className:"text-lg font-semibold text-amber-900",children:"Not Qualified for Any University"}),e.jsx("p",{className:"mt-2 text-sm text-amber-900",children:"You do not meet subject requirements for this course, so you are not qualified for any listed university."})]}),e.jsxs("article",{className:"rounded-2xl border border-rose-200 bg-rose-50 p-5",children:[e.jsx("h2",{className:"text-lg font-semibold text-rose-900",children:"Subject Requirements Not Met"}),e.jsx("ul",{className:"mt-3 space-y-1 text-sm text-rose-900",children:T.failed.map(y=>e.jsxs("li",{children:[y.subject," required >= ",y.required,y.studentSubject?` (you had ${y.studentSubject}: ${y.studentGrade})`:" (subject not done)"]},`${y.subject}-${y.required}`))})]})]}),e.jsx("div",{children:e.jsx(ln,{to:"/results",className:"text-sm font-medium text-slate-700 hover:text-slate-900",children:"Back to Results"})})]})}function wr({onRestoreByCode:r,payableAmount:i}){const n=mn(),[t,s]=o.useState(""),[a,I]=o.useState(""),[N,U]=o.useState(!1),T=async l=>{l.preventDefault(),I(""),U(!0);try{if(!await r(t)){I("Code not found. Confirm the code sent to your email.");return}n("/results")}catch(O){I(O.message||"Unable to load code.")}finally{U(!1)}};return e.jsxs("section",{className:"rounded-2xl border border-slate-200 bg-white p-8 shadow-sm md:p-12",children:[e.jsx("h1",{className:"mt-4 max-w-3xl text-3xl font-semibold tracking-tight text-slate-900 md:text-5xl",children:"Start a new calculation or continue with your access code"}),e.jsxs("p",{className:"mt-4 max-w-2xl text-base leading-relaxed text-slate-600 md:text-lg",children:["New users pay KES ",i,", then receive a unique code by email to reopen saved results later."]}),e.jsxs("div",{className:"mt-6 flex flex-row items-center gap-4",children:[e.jsx("div",{className:"mt-8",children:e.jsx(ln,{to:"/calculator",className:"inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-slate-900 to-slate-700 px-6 py-3 text-sm font-semibold text-white shadow-sm transition hover:from-slate-800 hover:to-slate-700",children:"Get Started"})}),e.jsxs("form",{onSubmit:T,className:"max-w-xl space-y-3 rounded-xl",children:[e.jsx("label",{htmlFor:"access_code",className:"block text-sm font-medium text-slate-700",children:"Have an access code? Paste it here"}),e.jsxs("div",{className:"flex flex-col gap-3 sm:flex-row",children:[e.jsx("input",{id:"access_code",type:"text",value:t,onChange:l=>s(l.target.value.toUpperCase()),placeholder:"e.g. 8F3KQ2P9",className:"ui-input",required:!0}),e.jsx("button",{type:"submit",disabled:N,className:"inline-flex items-center justify-center rounded-lg bg-emerald-700 px-6 py-2 text-sm font-semibold text-white transition enabled:hover:bg-emerald-600 disabled:cursor-not-allowed disabled:bg-emerald-400",children:N?"Opening...":"Open"})]}),e.jsx(b,{tone:"danger",message:a})]})]})]})}function Pr({clusters:r,getScore:i,courseCatalog:n,selectedCourses:t,onSelectCourse:s,onCheckCourse:a}){return e.jsx("div",{className:"mt-6 overflow-x-auto rounded-xl border border-slate-200",children:e.jsxs("table",{className:"min-w-full divide-y divide-slate-200 text-sm",children:[e.jsx("thead",{className:"bg-slate-100 text-left text-slate-700",children:e.jsxs("tr",{children:[e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Cluster"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Points"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Course Check"})]})}),e.jsx("tbody",{className:"divide-y divide-slate-100 bg-white text-slate-700",children:r.map(I=>{const N=n[I]||[];return e.jsxs("tr",{className:"align-top hover:bg-slate-50",children:[e.jsx("td",{className:"px-3 py-2 font-medium text-slate-900",children:I}),e.jsx("td",{className:"px-3 py-2",children:i(I)}),e.jsx("td",{className:"px-3 py-2",children:e.jsxs("div",{className:"flex flex-col gap-2 sm:flex-row",children:[e.jsxs("select",{value:t[I]||"",onChange:U=>s(I,U.target.value),className:"ui-select sm:max-w-sm",children:[e.jsx("option",{value:"",children:"Select Course"}),N.map(U=>e.jsx("option",{value:U.name,children:U.name},U.name))]}),e.jsx("button",{type:"button",disabled:!t[I],onClick:()=>a(I,t[I]),className:"inline-flex items-center justify-center rounded-lg bg-slate-900 px-3 py-2 text-xs font-semibold text-white transition enabled:hover:bg-slate-800 disabled:cursor-not-allowed disabled:bg-slate-400",children:"Check"})]})})]},I)})})]})})}function Dr({results:r,grades:i,source:n,courseCatalog:t,courseCatalogError:s,catalogLoading:a,accessCode:I,sessionMessage:N}){const U=mn(),[T,l]=o.useState({});if(!r||!i)return e.jsx(on,{to:"/",replace:!0});const O=Array.from({length:20},(S,L)=>L+1),y=S=>Number(r[S]??r[String(S)]??0);return e.jsxs("section",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsx("h1",{className:"text-2xl font-semibold tracking-tight",children:"All Cluster Points"}),e.jsx("p",{className:"mt-2 text-sm text-slate-600",children:"Select a course to evaluate your qualification details."}),e.jsxs("p",{className:"mt-1 text-xs font-medium text-slate-500",children:["Calculation source: ",gr(n)]}),I?e.jsx(b,{className:"mt-3",tone:"success",message:`Access code: ${I}`}):null,e.jsx(b,{className:"mt-2",tone:"info",message:N}),a?e.jsx(b,{className:"mt-2",tone:"info",message:"Loading course catalog..."}):null,e.jsx(b,{className:"mt-2",tone:"danger",message:s}),e.jsx(Pr,{clusters:O,getScore:y,courseCatalog:t,selectedCourses:T,onSelectCourse:(S,L)=>l(d=>({...d,[S]:L})),onCheckCourse:(S,L)=>U(`/course-result?cluster=${S}&course=${encodeURIComponent(L)}`)})]})}const jr=()=>Object.fromEntries(Object.keys(xn).map(r=>[r,""]));function kr(){const r=Zn(),[i,n]=o.useState(null),[t,s]=o.useState(null),[a,I]=o.useState("local-engine"),[N,U]=o.useState(""),[T,l]=o.useState(""),O=o.useMemo(()=>Be(),[]),y=r.pathname.startsWith("/admin");o.useEffect(()=>{Xn().catch(()=>{})},[]);const{courseCatalog:S,catalogLoading:L,courseCatalogError:d,saveCatalog:m,saveSingleCourse:C}=tr({mode:y?"admin":"public"}),{adminUser:Y,adminProfile:v,authLoading:h,authWorking:H,authError:J,isAdminAuthenticated:Q,login:q,loginWithGoogle:_,logout:z,addRegularAdmin:w}=he({enabled:y}),x=o.useCallback(async u=>{const A=await Je(u);return!A||!A.results?null:(n(A.grades||jr()),s(A.results||null),I("saved-session"),U(A.code),l(A.createdAt?`Loaded ${A.storage==="local"?"local":"saved"} session from ${new Date(A.createdAt).toLocaleString()}.`:`Loaded ${A.storage==="local"?"local":"saved"} session.`),A)},[]),W=o.useCallback(async u=>{await m(u)},[m]),X=o.useCallback(async u=>{await C(u)},[C]),M=o.useCallback(async(u,A)=>await q(u,A),[q]),G=o.useCallback(async()=>await _(),[_]),j=o.useCallback(async()=>{await z()},[z]),R=o.useCallback(u=>h?e.jsx("section",{className:"mx-auto max-w-xl rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:e.jsx(b,{tone:"info",message:"Checking admin authentication..."})}):Q?u:e.jsx(on,{to:"/admin/login",replace:!0}),[h,Q]);return e.jsx(Se,{children:e.jsxs(Ue,{children:[e.jsx(tn,{path:"/",element:e.jsx(wr,{onRestoreByCode:x,payableAmount:Pn})}),e.jsx(tn,{path:"/admin/login",element:e.jsx(sr,{isAuthenticated:Q,onLogin:M,onGoogleLogin:G,authError:J,isLoading:H||h})}),e.jsx(tn,{path:"/admin",element:R(e.jsx(Nr,{firebaseConfigured:O,onUploadCatalog:W,onAddSingleCourse:X,onLogout:j,onAddRegularAdmin:w,adminProfile:v,adminEmail:(Y==null?void 0:Y.email)||"",authError:J,courseCatalog:S}))}),e.jsx(tn,{path:"/admin/sessions",element:R(e.jsx(Sr,{firebaseConfigured:O}))}),e.jsx(tn,{path:"/calculator",element:e.jsx(Gr,{gradeOptions:Re,payableAmount:Pn,onCalculationReady:({grades:u,results:A,source:p,accessCode:Z,sessionMessage:an})=>{n(u),s(A),I(p),U(Z||""),l(an||"")}})}),e.jsx(tn,{path:"/payment",element:e.jsx(on,{to:"/calculator",replace:!0})}),e.jsx(tn,{path:"/results",element:e.jsx(Dr,{results:t,grades:i,source:a,courseCatalog:S,courseCatalogError:d,catalogLoading:L,accessCode:N,sessionMessage:T})}),e.jsx(tn,{path:"/course-result",element:e.jsx(Br,{results:t,grades:i,courseCatalog:S})}),e.jsx(tn,{path:"*",element:e.jsx(on,{to:"/",replace:!0})})]})})}Ae.createRoot(document.getElementById("root")).render(e.jsx(Te.StrictMode,{children:e.jsx(ye,{children:e.jsx(kr,{})})}));
