import{u as $n,j as e,L as En,r as I,P as zn,a as Cn,N as rn,R as Qn,A as Xn,S as ne,b as Gn,T as Hn,E as ee,c as re,C as ie,d as te,X as se,e as ae,f as oe,g as Ee,h as Q,i as Ie,k as le,B as ce}from"./vendor-1jWIULEY.js";(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))t(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const l of a.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&t(l)}).observe(document,{childList:!0,subtree:!0});function n(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function t(s){if(s.ep)return;s.ep=!0;const a=n(s);fetch(s.href,a)}})();const Ne=[{path:"/",label:"Home"},{path:"/calculator",label:"Calculator"},{path:"/admin",label:"Login"}];function Ue({children:r}){const{pathname:i}=$n(),n=t=>`rounded-lg px-3 py-2 text-sm font-medium transition ${i===t?"bg-gradient-to-r from-slate-900 to-slate-700 text-white shadow-sm":"text-slate-700 hover:bg-slate-100"}`;return e.jsxs("div",{className:"min-h-screen bg-mesh text-slate-900",children:[e.jsx("header",{className:"sticky top-0 z-20 border-b border-slate-200/80 bg-white/80 backdrop-blur",children:e.jsxs("div",{className:"mx-auto flex w-full max-w-7xl items-center justify-between px-4 py-4",children:[e.jsx(En,{to:"/",className:"text-lg font-semibold tracking-tight text-slate-900",children:"Cluster Calculation"}),e.jsx("nav",{className:"flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-2 py-1 shadow-sm",children:Ne.map(t=>e.jsx(En,{to:t.path,className:n(t.path),children:t.label},t.path))})]})}),e.jsx("main",{className:"mx-auto w-full max-w-7xl px-4 py-8",children:r})]})}const Fn={danger:"border-rose-200 bg-rose-50 text-rose-700",warning:"border-amber-200 bg-amber-50 text-amber-700",success:"border-emerald-200 bg-emerald-50 text-emerald-700",info:"border-slate-200 bg-slate-50 text-slate-700"};function p({message:r,tone:i="info",className:n=""}){return r?e.jsx("p",{className:`rounded-lg border px-3 py-2 text-sm ${Fn[i]||Fn.info} ${n}`,children:r}):null}const Ae=["A","A-","B+","B","B-","C+","C","C-","D+","D","D-","E"],Bn=1,gn=async r=>{try{const i=await r.text();return i?JSON.parse(i):null}catch{return null}},wn=(r,i)=>String((r==null?void 0:r.error)||(r==null?void 0:r.message)||i).trim()||i,Te=({enabled:r=!0}={})=>{const[i,n]=I.useState(null),[t,s]=I.useState(null),[a,l]=I.useState(r),[N,U]=I.useState(!1),[C,c]=I.useState(""),O=I.useMemo(()=>!0,[]),T=I.useCallback(async()=>{l(!0);try{const y=await fetch("/api/admin/me",{method:"GET",credentials:"include"}),g=await gn(y);if(!y.ok){n(null),s(null);return}n((g==null?void 0:g.user)||null),s((g==null?void 0:g.profile)||null),c("")}catch{n(null),s(null)}finally{l(!1)}},[]);I.useEffect(()=>{if(!r){l(!1);return}T().catch(()=>{})},[r,T]);const S=I.useCallback(async(y,g)=>{U(!0),c("");try{const Y=await fetch("/api/admin/login",{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:String(y||"").trim(),password:String(g||"")})}),v=await gn(Y);if(!Y.ok){const H=wn(v,"Authentication request failed.");return c(H),{success:!1,error:H}}return n((v==null?void 0:v.user)||null),s((v==null?void 0:v.profile)||null),c(""),{success:!0,user:(v==null?void 0:v.user)||void 0,profile:(v==null?void 0:v.profile)||void 0,error:""}}catch(Y){const v=(Y==null?void 0:Y.message)||"Authentication request failed.";return c(v),{success:!1,error:v}}finally{U(!1)}},[]),x=I.useCallback(async()=>{const y="Google popup login is disabled in backend-auth mode. Use email and password.";return c(y),{success:!1,error:y}},[]),u=I.useCallback(async()=>{U(!0);try{await fetch("/api/admin/logout",{method:"POST",credentials:"include"})}finally{n(null),s(null),c(""),U(!1)}},[]),h=I.useCallback(async({email:y,password:g,name:Y})=>{if(!i||!t)throw new Error("You must be logged in as admin.");if(t.role!=="super")throw new Error("Only a super admin can add regular admin users.");const v=await fetch("/api/admin/regular-admin",{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:String(y||"").trim(),password:String(g||""),name:String(Y||"").trim()})}),H=await gn(v);if(!v.ok)throw new Error(wn(H,"Unable to create regular admin."));return{user:(H==null?void 0:H.user)||null,profile:(H==null?void 0:H.profile)||null}},[t,i]);return{firebaseAuthReady:O,adminUser:i,adminProfile:t,authLoading:a,authWorking:N,authError:C,isAdminAuthenticated:!!(i&&t),login:S,loginWithGoogle:x,logout:u,addRegularAdmin:h}},fn={A:12,"A-":11,"B+":10,B:9,"B-":8,"C+":7,C:6,"C-":5,"D+":4,D:3,"D-":2,E:1},Vn={ENG:"English",KIS:"Kiswahili",MAT:"Mathematics",BIO:"Biology",CHE:"Chemistry",PHY:"Physics",GSC:"General Science",HAG:"History",GEO:"Geography",CRE:"CRE",IRE:"IRE",HRE:"HRE",CMP:"Computer Studies",AGR:"Agriculture",ARD:"Art & Design",HSC:"Home Science",BST:"Business Studies",FRE:"French",GER:"German",MUS:"Music",ARB:"Arabic"},Dn=[{title:"Group I",required:!0,subjects:["ENG","KIS","MAT"]},{title:"Group II (Sciences)",required:!1,subjects:["BIO","CHE","PHY","GSC"]},{title:"Group III (Humanities)",required:!1,subjects:["HAG","GEO","CRE","IRE","HRE"]},{title:"Group IV (Technical)",required:!1,subjects:["CMP","AGR","ARD","HSC"]},{title:"Group V (Others)",required:!1,subjects:["BST","FRE","GER","MUS","ARB"]}],ye=["ENG","KIS","MAT"],b=["BIO","CHE","PHY","GSC"],V=["HAG","GEO","CRE","IRE","HRE"],B=["CMP","AGR","ARD","HSC"],w=["BST","FRE","GER","MUS","ARB"],Un=[...ye,...b,...V,...B,...w],E=(r,i)=>Math.max(...i.map(n=>n in r?r[n]:0),0),D=(r,i,n)=>{const t=i.filter(s=>s in r).map(s=>r[s]).sort((s,a)=>a-s);return t.length>=n?t[n-1]:0},Ce=r=>{const i=Object.values(r).sort((n,t)=>t-n);return i.length>=7?i.slice(0,7).reduce((n,t)=>n+t,0):0},Se=(r,i)=>Number((Math.sqrt(r/48*(i/84))*48*.94).toFixed(3)),Re=r=>["BIO","CHE","MAT","PHY"].every(n=>r[n]&&r[n]in fn),Oe=(r,i)=>{const n={};for(const[l,N]of Object.entries(i))N in fn&&(n[l]=fn[N]);if(Object.keys(n).length<7)return 0;const t=Ce(n),s=()=>0;let a=0;if(r===1){if(!("ENG"in n||"KIS"in n))return s();a=E(n,["ENG","KIS"])+Math.max(n.MAT??0,E(n,b))+E(n,V)+Math.max(E(n,b),D(n,V,2),E(n,B),E(n,w))}else if(r===2){if(!("ENG"in n||"KIS"in n))return s();a=E(n,["ENG","KIS"])+(n.MAT??0)+Math.max(E(n,b),E(n,V))+Math.max(E(n,b),E(n,V),E(n,B),E(n,w))}else if(r===3){if(!("ENG"in n||"KIS"in n))return s();a=E(n,["ENG","KIS"])+Math.max(n.MAT??0,E(n,b))+E(n,V)+Math.max(E(n,b),D(n,V,2),E(n,B),E(n,w))}else if(r===4){if(!("MAT"in n&&"PHY"in n))return s();a=n.MAT+n.PHY+Math.max(n.BIO??0,n.CHE??0,n.GEO??0)+Math.max(E(n,b),E(n,V),E(n,B),E(n,w))}else if(r===5){if(!("MAT"in n&&"PHY"in n&&"CHE"in n))return s();a=n.MAT+n.PHY+n.CHE+Math.max(n.BIO??0,E(n,V),E(n,B),E(n,w))}else if(r===6){if(!("MAT"in n&&"PHY"in n))return s();a=n.MAT+n.PHY+E(n,V)+Math.max(D(n,b,2),D(n,V,2),E(n,B),E(n,w))}else if(r===7){if(!("MAT"in n&&"PHY"in n))return s();a=n.MAT+n.PHY+Math.max(D(n,b,2),E(n,V))+Math.max(E(n,b),E(n,V),E(n,B),E(n,w))}else if(r===8){if(!("MAT"in n&&"BIO"in n))return s();a=n.MAT+n.BIO+Math.max(n.PHY??0,n.CHE??0)+Math.max(D(n,b,3),E(n,V),E(n,B),E(n,w))}else if(r===9){if(!("MAT"in n))return s();a=n.MAT+E(n,b)+D(n,b,2)+Math.max(D(n,b,3),E(n,V),E(n,B),E(n,w))}else if(r===10){if(!("MAT"in n))return s();a=n.MAT+E(n,b)+E(n,V)+Math.max(D(n,b,2),D(n,V,2),E(n,B),E(n,w))}else if(r===11)a=Math.max((n.CHE??0)+Math.max(n.MAT??0,n.PHY??0)+Math.max(n.BIO??0,n.HSC??0)+Math.max(E(n,["ENG","KIS"]),E(n,V),E(n,B),E(n,w)),Math.max(n.BIO??0,n.GSC??0)+(n.MAT??0)+Math.max(E(n,b),E(n,V))+Math.max(E(n,["ENG","KIS"]),E(n,b),E(n,V),E(n,B),E(n,w)));else if(r===12||r===13){if(!("BIO"in n&&"CHE"in n))return s();a=n.BIO+n.CHE+Math.max(n.MAT??0,n.PHY??0)+Math.max(E(n,["ENG","KIS"]),D(n,b,3),E(n,V),E(n,B),E(n,w))}else if(r===14){if(!("CHE"in n))return s();a=Math.max(n.BIO??0,n.AGR??0,n.HSC??0)+n.CHE+Math.max(n.MAT??0,n.PHY??0,n.GEO??0)+Math.max(E(n,["ENG","KIS"]),E(n,V),E(n,B),E(n,w))}else if(r===15){if(!("BIO"in n&&"CHE"in n))return s();a=n.BIO+n.CHE+Math.max(n.MAT??0,n.PHY??0,n.AGR??0)+Math.max(E(n,["ENG","KIS"]),E(n,V),E(n,B),E(n,w))}else if(r===16){if(!("GEO"in n))return s();a=n.GEO+(n.MAT??0)+E(n,b)+Math.max(D(n,b,2),D(n,V,2),E(n,B),E(n,w))}else if(r===17){if(!("FRE"in n||"GER"in n))return s();a=E(n,["FRE","GER"])+E(n,["ENG","KIS"])+Math.max(n.MAT??0,E(n,b),E(n,V))+Math.max(E(n,b),E(n,V),E(n,B),D(n,w,2))}else if(r===18){if(!("MUS"in n))return s();a=n.MUS+E(n,["ENG","KIS"])+Math.max(n.MAT??0,E(n,b),E(n,V))+Math.max(E(n,b),E(n,V),E(n,B),D(n,w,2))}else if(r===19)a=E(n,Un)+D(n,Un,2)+D(n,Un,3)+D(n,Un,4);else if(r===20){if(!(n.CRE||n.IRE||n.HRE))return s();a=E(n,["CRE","IRE","HRE"])+E(n,["ENG","KIS"])+D(n,V,2)+Math.max(E(n,b),E(n,B),E(n,w))}else return s();return Se(a,t)},ue=r=>{const i={};for(let n=1;n<=20;n+=1)i[n]=Oe(n,r);return i},_n="kuccps.cluster.sessions",nn={catalog:"/api/catalog",adminCatalogUpload:"/api/admin/catalog/upload",adminCatalogCourse:"/api/admin/catalog/course",sessions:"/api/sessions",adminSessions:"/api/admin/sessions",adminSessionsBulkDelete:"/api/admin/sessions/delete-many"},Sn=async r=>{try{const i=await r.text();return i?JSON.parse(i):null}catch{return null}},Kn=async r=>{const i=await fetch(r,{method:"GET",credentials:"include"}),n=await Sn(i);return{ok:i.ok,status:i.status,data:n}},Rn=async(r,i)=>{const n=await fetch(r,{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify(i??{})}),t=await Sn(n);return{ok:n.ok,status:n.status,data:t}},de=async(r,i)=>{const n=await fetch(r,{method:"PATCH",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify(i??{})}),t=await Sn(n);return{ok:n.ok,status:n.status,data:t}},me=async r=>{const i=await fetch(r,{method:"DELETE",credentials:"include"}),n=await Sn(i);return{ok:i.ok,status:i.status,data:n}},en=(r,i)=>{const n=(r==null?void 0:r.data)||{};return String((n==null?void 0:n.error)||(n==null?void 0:n.message)||i)},cn=r=>String(r||"").trim().toUpperCase().replace(/[^A-Z0-9]/g,""),ln=r=>{const i=r&&typeof r=="object"?r:{},n={};for(let t=1;t<=20;t+=1){const s=Number(i[t]??i[String(t)]??0);n[t]=Number.isFinite(s)?s:0}return n},Ln=r=>{if(!r||typeof r!="object")return{};const i={};return Object.entries(r).forEach(([n,t])=>{const s=String(n||"").trim().toUpperCase(),a=String(t||"").trim().toUpperCase();!s||!a||(i[s]=a)}),i},bn=()=>{if(typeof window>"u")return{};try{const r=window.localStorage.getItem(_n);if(!r)return{};const i=JSON.parse(r);return i&&typeof i=="object"?i:{}}catch{return{}}},he=r=>{typeof window>"u"||window.localStorage.setItem(_n,JSON.stringify(r||{}))},An="ABCDEFGHJKLMNPQRSTUVWXYZ23456789",ve=(r=8)=>{if(typeof crypto<"u"&&crypto.getRandomValues){const n=new Uint8Array(r);return crypto.getRandomValues(n),Array.from(n,t=>An[t%An.length]).join("")}let i="";for(let n=0;n<r;n+=1){const t=Math.floor(Math.random()*An.length);i+=An[t]}return i},ge=()=>{const r=bn();for(let i=0;i<20;i+=1){const n=ve();if(!r[n])return n}throw new Error("Unable to generate a local access code.")},Ye=r=>{const i=bn();i[r.code]=r,he(i)},Me=(r,i="")=>({name:(r==null?void 0:r.name)||i,requirements:(r==null?void 0:r.requirements)||{},universities:Array.isArray(r==null?void 0:r.universities)?r.universities.map(n=>({name:String((n==null?void 0:n.name)||""),cutoff:Number((n==null?void 0:n.cutoff)??0),courseCode:String((n==null?void 0:n.courseCode)||"")})):[]}),fe=r=>(Array.isArray(r)?r:Object.values(r||{})).map(n=>Me(n)).filter(n=>!!n.name),Ve=r=>{if(!r||typeof r!="object")return{};const i={};return Object.entries(r).forEach(([n,t])=>{const s=Number(n);!Number.isInteger(s)||s<1||(i[s]=fe(t))}),i},Ke=()=>!0,Le=async()=>{const r=await Kn(nn.catalog);if(!r.ok)throw new Error(en(r,"Unable to load course catalog from backend."));return Ve(r.data||{})},be=async r=>{if(!r||typeof r!="object")throw new Error("Invalid course catalog payload.");const i=await Rn(nn.adminCatalogUpload,r);if(!i.ok)throw new Error(en(i,"Unable to upload course catalog to backend."))},xe=async({cluster:r,name:i,requirements:n,universities:t})=>{const s=await Rn(nn.adminCatalogCourse,{cluster:r,name:i,requirements:n,universities:t});if(!s.ok)throw new Error(en(s,"Unable to save course entry to backend."));return s.data||{}},pe=async({email:r,phoneNumber:i,amountPaid:n,grades:t,results:s,medicineEligible:a,paymentResponse:l})=>{const N=await Rn(nn.sessions,{email:r,phoneNumber:i,amountPaid:n,grades:t,results:s,medicineEligible:a,paymentResponse:l});if(!N.ok)throw new Error(en(N,"Unable to save session to backend."));const U=N.data||{};return{code:cn(U.code),email:String(U.email||"").trim(),phoneNumber:String(U.phoneNumber||"").trim(),amountPaid:Number(U.amountPaid??0),grades:Ln(U.grades),results:ln(U.results),medicineEligible:!!U.medicineEligible,paymentResponse:U.paymentResponse||null,createdAt:String(U.createdAt||""),updatedAt:String(U.updatedAt||""),storage:"firebase"}},Ge=async r=>{try{return{session:await pe(r),storage:"firebase",warning:""}}catch(i){const n=new Date().toISOString(),s={code:ge(),email:String((r==null?void 0:r.email)||"").trim(),phoneNumber:String((r==null?void 0:r.phoneNumber)||"").trim(),amountPaid:Number((r==null?void 0:r.amountPaid)??0),grades:(r==null?void 0:r.grades)||{},results:ln((r==null?void 0:r.results)||{}),medicineEligible:!!(r!=null&&r.medicineEligible),paymentResponse:(r==null?void 0:r.paymentResponse)||null,createdAt:n,updatedAt:n,storage:"local"};return Ye(s),{session:s,storage:"local",warning:(i==null?void 0:i.message)||"Backend save failed. Session saved locally on this browser only."}}},He=async r=>{const i=cn(r);if(!i)return null;const n=await Kn(`${nn.sessions}/${i}`);if(n.ok&&n.data){const s=n.data;return{code:i,email:String(s.email||"").trim(),phoneNumber:String(s.phoneNumber||"").trim(),amountPaid:Number(s.amountPaid??0),grades:Ln(s.grades),results:ln(s.results),medicineEligible:!!s.medicineEligible,paymentResponse:s.paymentResponse||null,createdAt:String(s.createdAt||""),updatedAt:String(s.updatedAt||""),storage:"firebase"}}const t=bn()[i];if(t)return{code:i,email:t.email||"",phoneNumber:t.phoneNumber||"",amountPaid:Number(t.amountPaid??0),grades:t.grades||{},results:ln(t.results||{}),medicineEligible:!!t.medicineEligible,paymentResponse:t.paymentResponse||null,createdAt:t.createdAt||"",updatedAt:t.updatedAt||"",storage:"local"};if(n.status!==404)throw new Error(en(n,"Unable to load session from backend."));return null},Fe=async()=>{const r=await Kn(nn.adminSessions);if(!r.ok)throw new Error(en(r,"Unable to load calculated sessions from backend."));return(Array.isArray(r.data)?r.data:[]).map(n=>({code:cn(n.code),email:String(n.email||"").trim(),phoneNumber:String(n.phoneNumber||"").trim(),amountPaid:Number(n.amountPaid??0),createdAt:String(n.createdAt||""),updatedAt:String(n.updatedAt||""),medicineEligible:!!n.medicineEligible,grades:Ln(n.grades),results:ln(n.results),paymentResponse:n.paymentResponse||null,storage:"firebase"})).filter(n=>n.code).sort((n,t)=>(Date.parse(t.createdAt||"")||0)-(Date.parse(n.createdAt||"")||0))},Be=async(r,i={})=>{const n=cn(r);if(!n)throw new Error("Session code is required.");const t=await de(`${nn.adminSessions}/${n}`,i);if(!t.ok)throw new Error(en(t,"Unable to update session."))},we=async r=>{const i=cn(r);if(!i)throw new Error("Session code is required.");const n=await me(`${nn.adminSessions}/${i}`);if(!n.ok)throw new Error(en(n,"Unable to delete session."))},De=async(r=[])=>{var n;const i=await Rn(nn.adminSessionsBulkDelete,{codes:Array.isArray(r)?r:[]});if(!i.ok)throw new Error(en(i,"Unable to delete selected sessions."));return Number(((n=i.data)==null?void 0:n.deleted)??0)},sn={courseName:"COURSE NAME",cluster:"CLUSTER",courseCode:"COURSE CODE",university:"UNIVERSITY",cutoff:"CUT-OFF POINTS",requirements:"MINIMUM SUBJECT REQUIREMENTS"},X=r=>String(r??"").replace(/\u00a0/g," ").trim(),Pe=r=>{const i=X(r).replace(/,/g,"");if(!i||i==="-")return 0;const n=Number.parseFloat(i);return Number.isFinite(n)?n:0},Pn=r=>{const i=X(r);if(!i||/^none$/i.test(i)||i==="-")return[];const n=[];return i.split(/\r?\n|;/).map(t=>t.trim()).filter(Boolean).forEach(t=>{if(/^none$/i.test(t)||t==="-")return;const s=t.indexOf(":");if(s<0)return;const a=t.slice(0,s).trim(),l=t.slice(s+1).trim().toUpperCase();!a||!l||l==="-"||n.push({subject:a,grade:l})}),n},je=(r=[],i=[])=>{const n=[...r];return i.forEach(t=>{if(!(t!=null&&t.subject)||!(t!=null&&t.grade))return;const s=n.findIndex(a=>a.subject===t.subject);s>=0?n[s]=t:n.push(t)}),n},ke=r=>{const i=new Set,n=[];return r.forEach(t=>{const s=`${t.name}|${t.courseCode}`;!t.name||i.has(s)||(i.add(s),n.push(t))}),n},Je=r=>Object.values(sn).some(i=>X(r==null?void 0:r[i])),Wn=r=>{const i=zn.parse(r,{header:!0,skipEmptyLines:!1});if(!Array.isArray(i.data)||!i.data.length)throw new Error("CSV has no records.");const n={};let t=null;const s=()=>{t&&(n[t.cluster]||(n[t.cluster]=[]),n[t.cluster].push({name:t.name,requirements:t.requirements,universities:ke(t.universities)}),t=null)};if(i.data.forEach(a=>{if(!a||typeof a!="object"||!Je(a))return;const l=X(a[sn.courseName]),N=X(a[sn.cluster]),U=X(a[sn.courseCode]),C=X(a[sn.university]),c=X(a[sn.cutoff]),O=X(a[sn.requirements]),T=Number(N);if(!!(l&&Number.isInteger(T)&&T>0))s(),t={name:l,cluster:T,requirements:Pn(O),universities:[]};else if(!t)return;O&&(t.requirements=je(t.requirements,Pn(O))),(C||U||c)&&t.universities.push({name:C||"Unknown University",courseCode:U,cutoff:Pe(c)})}),s(),!Object.keys(n).length)throw new Error("CSV did not produce a valid course catalog.");return n},qe=r=>{const i=Object.keys(r||{}).length;let n=0,t=0;return Object.values(r||{}).forEach(s=>{Array.isArray(s)&&(n+=s.length,s.forEach(a=>{t+=Array.isArray(a.universities)?a.universities.length:0}))}),{clusters:i,courses:n,universities:t}},$e=`COURSE NAME,CLUSTER,COURSE CODE,UNIVERSITY,CUT-OFF POINTS,MINIMUM SUBJECT REQUIREMENTS\r
...
,,1114488,University of Eldoret,15.092,\r
,,1093488,University of Embu,15.092,\r
`,_e=r=>{if(!Array.isArray(r))return{};const i={};return r.forEach(n=>{const t=String((n==null?void 0:n.subject)||"").trim(),s=String((n==null?void 0:n.grade)||"").trim().toUpperCase();!t||!s||(i[t]=s)}),i},We=r=>{if(!r||typeof r!="object")return{};const i={};return Object.entries(r).forEach(([n,t])=>{const s=Number(n);if(!Number.isInteger(s)||s<1)return;const a=Array.isArray(t)?t:[];i[s]=a.map(l=>({name:String((l==null?void 0:l.name)||"").trim(),requirements:_e(l==null?void 0:l.requirements),universities:Array.isArray(l==null?void 0:l.universities)?l.universities.map(N=>({name:String((N==null?void 0:N.name)||"").trim(),courseCode:String((N==null?void 0:N.courseCode)||"").trim(),cutoff:Number((N==null?void 0:N.cutoff)??0)})).filter(N=>!!N.name):[]})).filter(l=>!!l.name)}),i};let Tn=null;const jn=()=>{if(Tn)return Tn;const r=Wn($e);return Tn=We(r),Tn},Ze=({mode:r="public"}={})=>{const[i,n]=I.useState({}),[t,s]=I.useState(!0),[a,l]=I.useState(""),N=I.useCallback(async()=>{if(s(!0),r!=="admin"){try{const c=jn();n(c),l("")}catch(c){n({}),l((c==null?void 0:c.message)||"Unable to load bundled course catalog.")}finally{s(!1)}return}try{const c=await Le();n(c),l("")}catch(c){const O=jn();n(O);const T=(c==null?void 0:c.message)||"Unable to load courses from realtime database.";l(`${T} Showing bundled courses until backend connection is available.`)}finally{s(!1)}},[r]),U=I.useCallback(async c=>{if(r!=="admin")throw new Error("Catalog updates are only available in admin mode.");await be(c),l(""),await N()},[N,r]),C=I.useCallback(async c=>{if(r!=="admin")throw new Error("Catalog updates are only available in admin mode.");await xe(c),l(""),await N()},[N,r]);return I.useEffect(()=>{N().catch(()=>{})},[N]),{courseCatalog:i,catalogLoading:t,courseCatalogError:a,loadCatalog:N,saveCatalog:U,saveSingleCourse:C}};function ze({isAuthenticated:r,onLogin:i,onGoogleLogin:n,authError:t,isLoading:s}){const a=Cn(),[l,N]=I.useState(""),[U,C]=I.useState(""),[c,O]=I.useState(!1),[T,S]=I.useState("");if(r)return e.jsx(rn,{to:"/admin",replace:!0});const x=async h=>{h.preventDefault(),S("");const y=await i(l,U);if(y.success){a("/admin");return}S(y.error||"Invalid admin credentials.")},u=async()=>{S("");const h=await n();if(h.success){a("/admin");return}S(h.error||"Google sign-in failed.")};return e.jsxs("section",{className:"mx-auto max-w-lg rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsx("h1",{className:"text-2xl font-semibold tracking-tight",children:"Admin Login"}),e.jsx("p",{className:"mt-2 text-sm text-slate-600",children:"Only admins can upload course data to Firebase."}),e.jsxs("form",{onSubmit:x,className:"mt-6 space-y-4",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"admin_email",className:"mb-1 block text-sm font-medium text-slate-700",children:"Email"}),e.jsx("input",{id:"admin_email",type:"email",value:l,onChange:h=>N(h.target.value),required:!0,className:"ui-input",placeholder:"admin@example.com"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"admin_password",className:"mb-1 block text-sm font-medium text-slate-700",children:"Password"}),e.jsxs("div",{className:"relative",children:[e.jsx("input",{id:"admin_password",type:c?"text":"password",value:U,onChange:h=>C(h.target.value),required:!0,className:"ui-input pr-20"}),e.jsx("button",{type:"button",onClick:()=>O(h=>!h),className:"absolute right-2 top-1/2 -translate-y-1/2 rounded-lg border border-slate-200 bg-white px-2.5 py-1 text-xs font-semibold text-slate-600 transition hover:bg-slate-50",children:c?"Hide":"View"})]})]}),e.jsx(p,{tone:"danger",message:T}),e.jsx(p,{tone:"danger",message:t}),e.jsx("button",{type:"submit",disabled:s,className:"inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-slate-900 to-slate-700 px-4 py-2 text-sm font-semibold text-white transition hover:from-slate-800 hover:to-slate-700",children:s?"Signing in...":"Login"}),e.jsxs("div",{className:"relative py-1",children:[e.jsx("div",{className:"absolute inset-0 flex items-center",children:e.jsx("span",{className:"w-full border-t border-slate-200"})}),e.jsx("div",{className:"relative flex justify-center",children:e.jsx("span",{className:"bg-white px-2 text-xs text-slate-500",children:"OR"})})]}),e.jsx("button",{type:"button",onClick:u,disabled:s,className:"inline-flex w-full items-center justify-center rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-100 disabled:cursor-not-allowed disabled:text-slate-400",children:"Continue with Google"})]})]})}const Qe="/assets/courses-CtX9VR_p.csv",Xe=r=>new Promise((i,n)=>{const t=new FileReader;t.onload=()=>i(String(t.result||"")),t.onerror=()=>n(new Error("Unable to read selected file.")),t.readAsText(r)});function nr({firebaseConfigured:r,onUploadCatalog:i,bundledCoursesCsvUrl:n}){const[t,s]=I.useState(""),[a,l]=I.useState(""),[N,U]=I.useState(!1),[C,c]=I.useState(null),O=async(u,h)=>{s(""),l(""),U(!0);try{const y=Wn(u);await i(y);const g=qe(y);l(`${h} uploaded: ${g.clusters} clusters, ${g.courses} courses, ${g.universities} universities.`)}catch(y){s(y.message||"Failed to upload course catalog.")}finally{U(!1)}},T=async()=>{if(!C){s("Select a CSV file first.");return}try{const u=await Xe(C);await O(u,C.name)}catch(u){s(u.message||"Failed to read selected CSV file.")}},S=async()=>{try{const u=await fetch(n);if(!u.ok)throw new Error(`Unable to load bundled CSV (status ${u.status}).`);const h=await u.text();await O(h,"courses.csv")}catch(u){s(u.message||"Failed to upload bundled courses.csv.")}},x=u=>{var h;c(((h=u.target.files)==null?void 0:h[0])||null)};return e.jsxs("section",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsx("h2",{className:"text-xl font-semibold tracking-tight",children:"Courses Upload"}),e.jsx("p",{className:"mt-1 text-sm text-slate-600",children:"Upload a `courses.csv` compatible file through backend API into Firebase realtime database."}),r?null:e.jsx(p,{className:"mt-4",tone:"warning",message:"Backend Firebase integration is not available."}),e.jsxs("div",{className:"mt-5 flex flex-col gap-3 sm:flex-row sm:items-end",children:[e.jsxs("div",{className:"w-full sm:max-w-md",children:[e.jsx("label",{htmlFor:"admin_csv_upload",className:"mb-1 block text-sm font-medium text-slate-700",children:"Select CSV file"}),e.jsx("input",{id:"admin_csv_upload",type:"file",accept:".csv,text/csv",onChange:x,className:"ui-file-input"})]}),e.jsx("button",{type:"button",onClick:T,disabled:N||!r,className:"inline-flex items-center justify-center rounded-lg bg-slate-900 px-4 py-2 text-sm font-semibold text-white transition enabled:hover:bg-slate-800 disabled:cursor-not-allowed disabled:bg-slate-400",children:"Upload Selected CSV"}),e.jsx("button",{type:"button",onClick:S,disabled:N||!r,className:"inline-flex items-center justify-center rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition enabled:hover:bg-slate-100 disabled:cursor-not-allowed disabled:text-slate-400",children:"Upload Bundled courses.csv"})]}),e.jsx(p,{className:"mt-3",tone:"danger",message:t}),e.jsx(p,{className:"mt-3",tone:"success",message:a})]})}const kn={name:"",email:"",password:""},er={cluster:"",name:"",requirementsText:"",universityName:"",courseCode:"",cutoff:""},rr=r=>{const i={};return String(r||"").split(/\r?\n|;/).map(n=>n.trim()).filter(Boolean).forEach(n=>{const t=n.indexOf(":");if(t<0)return;const s=n.slice(0,t).trim(),a=n.slice(t+1).trim().toUpperCase();!s||!a||(i[s]=a)}),i},ir=r=>{const i=Object.keys(r||{}).length;let n=0,t=0;return Object.values(r||{}).forEach(s=>{Array.isArray(s)&&(n+=s.length,s.forEach(a=>{t+=Array.isArray(a==null?void 0:a.universities)?a.universities.length:0}))}),{clusters:i,courses:n,universities:t}};function tr({firebaseConfigured:r,onUploadCatalog:i,onAddSingleCourse:n,onLogout:t,onAddRegularAdmin:s,adminProfile:a,adminEmail:l,authError:N,courseCatalog:U}){const[C,c]=I.useState(kn),[O,T]=I.useState(!1),[S,x]=I.useState(""),[u,h]=I.useState(""),[y,g]=I.useState(er),[Y,v]=I.useState(!1),[H,F]=I.useState(""),[q,_]=I.useState(""),j=(a==null?void 0:a.role)==="super",$=I.useMemo(()=>ir(U),[U]),k=(M,A)=>{c(d=>({...d,[M]:A}))},G=(M,A)=>{g(d=>({...d,[M]:A}))},J=async M=>{if(M.preventDefault(),x(""),h(""),!j){x("Only a super admin can add regular admins.");return}if(!C.email||!C.password){x("Email and password are required.");return}T(!0);try{const A=await s({name:C.name,email:C.email,password:C.password});h(`Regular admin added: ${A.user.email}`),c(kn)}catch(A){x(A.message||"Unable to add regular admin.")}finally{T(!1)}},W=async M=>{if(M.preventDefault(),F(""),_(""),!r){F("Firebase is not configured.");return}const A=Number(y.cluster);if(!Number.isInteger(A)||A<1){F("Cluster must be a whole number greater than 0.");return}const d=String(y.name||"").trim();if(!d){F("Course name is required.");return}const m=String(y.universityName||"").trim();if(!m){F("University name is required.");return}const f=String(y.cutoff||"").trim(),K=f?Number(f):0;if(!Number.isFinite(K)||K<0){F("Cutoff must be a number equal to or greater than 0.");return}v(!0);try{await n({cluster:A,name:d,requirements:rr(y.requirementsText),universities:[{name:m,courseCode:String(y.courseCode||"").trim(),cutoff:K}]}),_(`Saved "${d}" in cluster ${A}.`),g(Z=>({...Z,universityName:"",courseCode:"",cutoff:""}))}catch(Z){F(Z.message||"Unable to save course.")}finally{v(!1)}};return e.jsxs("section",{className:"space-y-6",children:[e.jsxs("div",{className:"relative overflow-hidden rounded-3xl border border-cyan-100 bg-gradient-to-br from-white via-cyan-50 to-emerald-50 p-6 shadow-sm",children:[e.jsx("div",{className:"pointer-events-none absolute -top-14 -right-12 h-44 w-44 rounded-full bg-cyan-200/40 blur-2xl"}),e.jsx("div",{className:"pointer-events-none absolute -bottom-10 -left-10 h-36 w-36 rounded-full bg-emerald-200/50 blur-2xl"}),e.jsxs("div",{className:"relative",children:[e.jsxs("div",{className:"flex flex-wrap items-start justify-between gap-3",children:[e.jsxs("div",{children:[e.jsx("p",{className:"inline-flex rounded-full border border-cyan-200 bg-white/70 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-cyan-700",children:"Control Center"}),e.jsx("h1",{className:"mt-3 text-3xl font-semibold tracking-tight text-slate-900",children:"Admin Dashboard"}),e.jsx("p",{className:"mt-2 max-w-2xl text-sm text-slate-600",children:"Manage admins and maintain course catalog content for calculator results and eligibility checks."}),e.jsxs("p",{className:"mt-3 text-xs font-medium text-slate-500",children:["Signed in as: ",l||"unknown"," (",(a==null?void 0:a.role)||"regular"," admin)"]})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(En,{to:"/admin/sessions",className:"inline-flex items-center justify-center rounded-xl border border-cyan-300 bg-cyan-50 px-4 py-2 text-sm font-semibold text-cyan-700 transition hover:bg-cyan-100",children:"View Calculated Users"}),e.jsx("button",{type:"button",onClick:t,className:"inline-flex items-center justify-center rounded-xl border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-100",children:"Logout"})]})]}),e.jsxs("div",{className:"mt-5 grid gap-3 sm:grid-cols-3",children:[e.jsxs("div",{className:"rounded-xl border border-slate-200 bg-white/80 p-4",children:[e.jsx("p",{className:"text-xs uppercase tracking-wider text-slate-500",children:"Clusters"}),e.jsx("p",{className:"mt-2 text-2xl font-semibold text-slate-900",children:$.clusters})]}),e.jsxs("div",{className:"rounded-xl border border-slate-200 bg-white/80 p-4",children:[e.jsx("p",{className:"text-xs uppercase tracking-wider text-slate-500",children:"Courses"}),e.jsx("p",{className:"mt-2 text-2xl font-semibold text-slate-900",children:$.courses})]}),e.jsxs("div",{className:"rounded-xl border border-slate-200 bg-white/80 p-4",children:[e.jsx("p",{className:"text-xs uppercase tracking-wider text-slate-500",children:"University Entries"}),e.jsx("p",{className:"mt-2 text-2xl font-semibold text-slate-900",children:$.universities})]})]})]}),e.jsx(p,{className:"mt-3",tone:"danger",message:N})]}),e.jsxs("div",{className:"grid gap-6 xl:grid-cols-2",children:[e.jsxs("div",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsx("h2",{className:"text-xl font-semibold tracking-tight text-slate-900",children:"Admin Users"}),e.jsx("p",{className:"mt-1 text-sm text-slate-600",children:"Create regular admin accounts that can log in and access admin tools."}),j?null:e.jsx(p,{className:"mt-3",tone:"warning",message:"Only a super admin can add regular admin users."}),e.jsxs("form",{onSubmit:J,className:"mt-5 grid gap-4 md:grid-cols-3",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"regular_admin_name",className:"mb-1 block text-sm font-medium text-slate-700",children:"Full Name"}),e.jsx("input",{id:"regular_admin_name",type:"text",value:C.name,onChange:M=>k("name",M.target.value),className:"ui-input",placeholder:"Admin Name"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"regular_admin_email",className:"mb-1 block text-sm font-medium text-slate-700",children:"Email"}),e.jsx("input",{id:"regular_admin_email",type:"email",value:C.email,onChange:M=>k("email",M.target.value),required:!0,className:"ui-input",placeholder:"newadmin@example.com"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"regular_admin_password",className:"mb-1 block text-sm font-medium text-slate-700",children:"Password"}),e.jsx("input",{id:"regular_admin_password",type:"password",value:C.password,onChange:M=>k("password",M.target.value),required:!0,minLength:6,className:"ui-input",placeholder:"At least 6 characters"})]}),e.jsx("div",{className:"md:col-span-3",children:e.jsx("button",{type:"submit",disabled:!j||O,className:"inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-slate-900 to-slate-700 px-4 py-2 text-sm font-semibold text-white transition enabled:hover:from-slate-800 enabled:hover:to-slate-600 disabled:cursor-not-allowed disabled:bg-slate-400",children:O?"Creating...":"Add Regular Admin"})})]}),e.jsx(p,{className:"mt-3",tone:"danger",message:S}),e.jsx(p,{className:"mt-3",tone:"success",message:u})]}),e.jsxs("div",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsx("h2",{className:"text-xl font-semibold tracking-tight text-slate-900",children:"Add Single Course"}),e.jsx("p",{className:"mt-1 text-sm text-slate-600",children:"Add one course entry at a time. If the course already exists in the same cluster, the university entry is merged into it."}),r?null:e.jsx(p,{className:"mt-3",tone:"warning",message:"Firebase is not configured for catalog writes."}),e.jsxs("form",{onSubmit:W,className:"mt-5 grid gap-4 md:grid-cols-2",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"single_course_cluster",className:"mb-1 block text-sm font-medium text-slate-700",children:"Cluster"}),e.jsx("input",{id:"single_course_cluster",type:"number",min:1,value:y.cluster,onChange:M=>G("cluster",M.target.value),required:!0,className:"ui-input",placeholder:"e.g. 2"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"single_course_name",className:"mb-1 block text-sm font-medium text-slate-700",children:"Course Name"}),e.jsx("input",{id:"single_course_name",type:"text",value:y.name,onChange:M=>G("name",M.target.value),required:!0,className:"ui-input",placeholder:"BACHELOR OF COMMERCE"})]}),e.jsxs("div",{className:"md:col-span-2",children:[e.jsx("label",{htmlFor:"single_course_requirements",className:"mb-1 block text-sm font-medium text-slate-700",children:"Minimum Subject Requirements"}),e.jsx("textarea",{id:"single_course_requirements",value:y.requirementsText,onChange:M=>G("requirementsText",M.target.value),rows:4,className:"ui-textarea",placeholder:`Mathematics: C+
English/Kiswahili: B`})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"single_course_university",className:"mb-1 block text-sm font-medium text-slate-700",children:"University"}),e.jsx("input",{id:"single_course_university",type:"text",value:y.universityName,onChange:M=>G("universityName",M.target.value),required:!0,className:"ui-input",placeholder:"University of Nairobi"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"single_course_code",className:"mb-1 block text-sm font-medium text-slate-700",children:"Course Code"}),e.jsx("input",{id:"single_course_code",type:"text",value:y.courseCode,onChange:M=>G("courseCode",M.target.value),className:"ui-input",placeholder:"1263134"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"single_course_cutoff",className:"mb-1 block text-sm font-medium text-slate-700",children:"Cutoff Points"}),e.jsx("input",{id:"single_course_cutoff",type:"number",step:"0.001",min:0,value:y.cutoff,onChange:M=>G("cutoff",M.target.value),className:"ui-input",placeholder:"32.613"})]}),e.jsx("div",{className:"md:col-span-2",children:e.jsx("button",{type:"submit",disabled:Y||!r,className:"inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-emerald-600 to-cyan-600 px-4 py-2 text-sm font-semibold text-white transition enabled:hover:from-emerald-500 enabled:hover:to-cyan-500 disabled:cursor-not-allowed disabled:bg-slate-400",children:Y?"Saving...":"Save Course Entry"})})]}),e.jsx(p,{className:"mt-3",tone:"danger",message:H}),e.jsx(p,{className:"mt-3",tone:"success",message:q})]})]}),e.jsx(nr,{firebaseConfigured:r,onUploadCatalog:i,bundledCoursesCsvUrl:Qe})]})}const In=20,sr=["BIO","CHE","MAT","PHY"],yn={code:"",email:"",phoneNumber:"",amountPaid:"0",medicineEligible:!1},ar=r=>{if(!r)return"Unknown";const i=Date.parse(r);return Number.isFinite(i)?new Date(i).toLocaleString():"Unknown"},Yn=r=>{const i=Number(r);return Number.isFinite(i)?i.toFixed(3):"0.000"},Zn=r=>{const i=r&&typeof r=="object"?r:{};return Array.from({length:20},(n,t)=>{const s=t+1;return{cluster:s,score:Number(i[s]??i[String(s)]??0)}}).map(n=>({...n,score:Number.isFinite(n.score)?n.score:0}))},or=(r,i=3)=>Zn(r).sort((n,t)=>t.score-n.score||n.cluster-t.cluster).slice(0,i),Er=r=>[r.code,r.email,r.phoneNumber,r.amountPaid,r.createdAt,r.medicineEligible?"eligible":"not-eligible"].join(" ").toLowerCase(),Ir=(r,i)=>{if(i<=7)return Array.from({length:i},(t,s)=>s+1);const n=Math.max(1,Math.min(r-3,i-6));return Array.from({length:7},(t,s)=>n+s)};function lr({firebaseConfigured:r}){const[i,n]=I.useState([]),[t,s]=I.useState(!0),[a,l]=I.useState(""),[N,U]=I.useState(""),[C,c]=I.useState(""),[O,T]=I.useState(""),[S,x]=I.useState(""),[u,h]=I.useState([]),[y,g]=I.useState(1),[Y,v]=I.useState(yn),[H,F]=I.useState(!1),[q,_]=I.useState(!1),[j,$]=I.useState(""),k=I.useCallback(async()=>{if(!r){s(!1),l("Firebase is not configured."),n([]);return}s(!0),l("");try{const o=await Fe();n(o)}catch(o){l(o.message||"Unable to load cluster sessions."),n([])}finally{s(!1)}},[r]);I.useEffect(()=>{k().catch(()=>{})},[k]);const G=I.useMemo(()=>{const o=String(O||"").trim().toLowerCase();return o?i.filter(R=>Er(R).includes(o)):i},[O,i]),J=I.useMemo(()=>Math.max(1,Math.ceil(G.length/In)),[G.length]),W=I.useMemo(()=>{const o=(y-1)*In;return G.slice(o,o+In)},[y,G]);I.useMemo(()=>{const o=new Set(G.map(L=>L.email||L.phoneNumber||L.code)).size,R=G.filter(L=>L.medicineEligible).length;return{totalSessions:G.length,uniqueUsers:o,medicineQualifiedCount:R}},[G]);const M=I.useMemo(()=>new Set(u),[u]),A=I.useMemo(()=>W.map(o=>o.code),[W]),d=A.length>0&&A.every(o=>M.has(o));I.useEffect(()=>{g(1)},[O]),I.useEffect(()=>{y>J&&g(J)},[y,J]),I.useEffect(()=>{const o=new Set(G.map(R=>R.code));h(R=>R.filter(L=>o.has(L))),S&&!o.has(S)&&x(""),Y.code&&!o.has(Y.code)&&v(yn)},[Y.code,S,G]);const m=o=>{h(R=>{const L=new Set(R);return L.has(o)?L.delete(o):L.add(o),Array.from(L)})},f=()=>{h(o=>{const R=new Set(o);return d?A.forEach(L=>R.delete(L)):A.forEach(L=>R.add(L)),Array.from(R)})},K=()=>{H||v(yn)},Z=async o=>{if(o.preventDefault(),!Y.code)return;U(""),c("");const R=Number(Y.amountPaid);if(!Number.isFinite(R)||R<0){U("Amount paid must be a valid number equal to or greater than 0.");return}F(!0);try{await Be(Y.code,{email:Y.email,phoneNumber:Y.phoneNumber,amountPaid:R,medicineEligible:Y.medicineEligible}),c(`Session ${Y.code} updated successfully.`),v(yn),await k()}catch(L){U(L.message||"Unable to update session.")}finally{F(!1)}},z=async o=>{if(o&&(U(""),c(""),!!window.confirm(`Delete session ${o}?`))){$(o);try{await we(o),c(`Session ${o} deleted.`),h(R=>R.filter(L=>L!==o)),S===o&&x(""),await k()}catch(R){U(R.message||"Unable to delete session.")}finally{$("")}}},tn=async()=>{if(u.length&&(U(""),c(""),!!window.confirm(`Delete ${u.length} selected session(s)?`))){_(!0);try{const o=await De(u);c(`${o} session(s) deleted.`),h([]),S&&u.includes(S)&&x(""),await k()}catch(o){U(o.message||"Unable to delete selected sessions.")}finally{_(!1)}}},an=I.useMemo(()=>Ir(y,J),[y,J]),mn=G.length?(y-1)*In+1:0,hn=Math.min(G.length,y*In);return e.jsxs("section",{className:"space-y-6",children:[e.jsx("div",{className:"rounded-3xl border border-cyan-100 bg-gradient-to-br from-white via-cyan-50 to-emerald-50 p-6 shadow-sm",children:e.jsxs("div",{className:"flex flex-wrap items-start justify-between gap-3",children:[e.jsxs("div",{children:[e.jsx("p",{className:"inline-flex rounded-full border border-cyan-200 bg-white/70 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-cyan-700",children:"Admin Analytics"}),e.jsx("h1",{className:"mt-3 text-3xl font-semibold tracking-tight text-slate-900",children:"Calculated Users Table"}),e.jsx("p",{className:"mt-2 text-sm text-slate-600",children:"Review users who calculated cluster points and manage records safely."})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsxs("button",{type:"button",onClick:()=>k(),className:"inline-flex items-center justify-center gap-1.5 rounded-xl border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-100",children:[e.jsx(Qn,{className:"h-4 w-4"}),"Refresh"]}),e.jsxs(En,{to:"/admin",className:"inline-flex items-center justify-center gap-1.5 rounded-xl bg-gradient-to-r from-slate-900 to-slate-700 px-4 py-2 text-sm font-semibold text-white transition hover:from-slate-800 hover:to-slate-600",children:[e.jsx(Xn,{className:"h-4 w-4"}),"Back to Admin"]})]})]})}),e.jsxs("div",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsxs("div",{className:"flex flex-wrap items-center justify-between gap-3",children:[e.jsx("h2",{className:"text-xl font-semibold tracking-tight text-slate-900",children:"User Calculations"}),e.jsxs("div",{className:"flex w-full flex-wrap items-center justify-end gap-2 lg:w-auto",children:[e.jsx("input",{type:"search",value:O,onChange:o=>T(o.target.value),placeholder:"Search by email, code, phone...",className:"ui-input w-full max-w-sm"}),e.jsxs("button",{type:"button",onClick:f,disabled:!A.length,className:"inline-flex items-center justify-center gap-1.5 rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm font-semibold text-slate-700 transition enabled:hover:bg-slate-100 disabled:cursor-not-allowed disabled:text-slate-400",children:[d?e.jsx(ne,{className:"h-4 w-4"}):e.jsx(Gn,{className:"h-4 w-4"}),d?"Unselect Page":"Select Page"]}),e.jsxs("button",{type:"button",onClick:tn,disabled:!u.length||q,className:"inline-flex items-center justify-center gap-1.5 rounded-xl bg-rose-600 px-3 py-2 text-sm font-semibold text-white transition enabled:hover:bg-rose-500 disabled:cursor-not-allowed disabled:bg-slate-400",children:[e.jsx(Hn,{className:"h-4 w-4"}),q?"Deleting...":`Delete Selected (${u.length})`]})]})]}),e.jsx(p,{className:"mt-3",tone:"danger",message:a}),e.jsx(p,{className:"mt-3",tone:"danger",message:N}),e.jsx(p,{className:"mt-3",tone:"success",message:C}),t?e.jsx(p,{className:"mt-3",tone:"info",message:"Loading sessions..."}):null,e.jsx("div",{className:"mt-4 overflow-x-auto",children:e.jsxs("table",{className:"min-w-full divide-y divide-slate-200 text-sm",children:[e.jsx("thead",{className:"bg-slate-50 text-left text-xs uppercase tracking-wider text-slate-500",children:e.jsxs("tr",{children:[e.jsx("th",{className:"px-3 py-3 font-semibold",children:e.jsx("input",{type:"checkbox",checked:d,onChange:f,"aria-label":"Select all on current page",className:"ui-checkbox"})}),e.jsx("th",{className:"px-3 py-3 font-semibold",children:"Date"}),e.jsx("th",{className:"px-3 py-3 font-semibold",children:"Access Code"}),e.jsx("th",{className:"px-3 py-3 font-semibold",children:"User"}),e.jsx("th",{className:"px-3 py-3 font-semibold",children:"Best Cluster"}),e.jsx("th",{className:"px-3 py-3 font-semibold",children:"Top 3 Cluster Points"}),e.jsx("th",{className:"px-3 py-3 font-semibold",children:"Actions"})]})}),e.jsxs("tbody",{className:"divide-y divide-slate-200 bg-white text-slate-700",children:[!t&&!W.length?e.jsx("tr",{children:e.jsx("td",{colSpan:8,className:"px-3 py-8 text-center text-sm text-slate-500",children:"No calculation sessions found."})}):null,W.map(o=>{const R=or(o.results),L=R[0],vn=Object.entries(o.grades||{}).filter(([,P])=>P),xn=j===o.code;return e.jsxs(I.Fragment,{children:[e.jsxs("tr",{children:[e.jsx("td",{className:"whitespace-nowrap px-3 py-3",children:e.jsx("input",{type:"checkbox",checked:M.has(o.code),onChange:()=>m(o.code),"aria-label":`Select ${o.code}`,className:"ui-checkbox"})}),e.jsx("td",{className:"whitespace-nowrap px-3 py-3",children:ar(o.createdAt)}),e.jsx("td",{className:"whitespace-nowrap px-3 py-3 font-mono font-semibold text-slate-900",children:o.code}),e.jsxs("td",{className:"px-3 py-3",children:[e.jsx("p",{className:"font-medium text-slate-900",children:o.email||"No email"}),e.jsx("p",{className:"text-xs text-slate-500",children:o.phoneNumber||"No phone"})]}),e.jsx("td",{className:"whitespace-nowrap px-3 py-3",children:L?`C${L.cluster}: ${Yn(L.score)}`:"N/A"}),e.jsx("td",{className:"px-3 py-3",children:e.jsx("div",{className:"flex flex-wrap gap-1.5",children:R.map(P=>e.jsxs("span",{className:"rounded-full border border-slate-200 bg-slate-50 px-2 py-1 text-xs font-medium text-slate-700",children:["C",P.cluster,": ",Yn(P.score)]},`${o.code}-${P.cluster}`))})}),e.jsx("td",{className:"whitespace-nowrap px-3 py-3",children:e.jsxs("div",{className:"flex items-center gap-1.5",children:[e.jsxs("button",{type:"button",onClick:()=>x(P=>P===o.code?"":o.code),className:"inline-flex items-center justify-center gap-1 rounded-lg border border-slate-300 bg-white px-2.5 py-1.5 text-xs font-semibold text-slate-700 transition hover:bg-slate-100",children:[S===o.code?e.jsx(ee,{className:"h-3.5 w-3.5"}):e.jsx(re,{className:"h-3.5 w-3.5"}),S===o.code?"Hide":"View"]}),e.jsxs("button",{type:"button",onClick:()=>z(o.code),disabled:xn,className:"inline-flex items-center justify-center gap-1 rounded-lg border border-rose-300 bg-rose-50 px-2.5 py-1.5 text-xs font-semibold text-rose-700 transition enabled:hover:bg-rose-100 disabled:cursor-not-allowed disabled:text-rose-400",children:[e.jsx(Hn,{className:"h-3.5 w-3.5"}),xn?"Deleting...":"Delete"]})]})})]}),S===o.code?e.jsx("tr",{className:"bg-slate-50/70",children:e.jsx("td",{colSpan:8,className:"px-3 py-4",children:e.jsxs("div",{className:"grid gap-4 lg:grid-cols-3",children:[e.jsxs("div",{className:"rounded-xl border border-slate-200 bg-white p-3",children:[e.jsx("h3",{className:"text-sm font-semibold text-slate-900",children:"Qualification Details"}),e.jsx("p",{className:"mt-2 text-xs text-slate-600",children:"Medicine core subjects (BIO, CHE, MAT, PHY):"}),e.jsx("div",{className:"mt-2 flex flex-wrap gap-1.5",children:sr.map(P=>{var Nn,pn;return e.jsxs("span",{className:`rounded-full border px-2 py-1 text-xs font-medium ${(Nn=o.grades)!=null&&Nn[P]?"border-emerald-200 bg-emerald-50 text-emerald-700":"border-rose-200 bg-rose-50 text-rose-700"}`,children:[P,": ",((pn=o.grades)==null?void 0:pn[P])||"Missing"]},`${o.code}-${P}`)})}),e.jsxs("p",{className:"mt-3 text-xs text-slate-500",children:["Amount Paid: KES ",o.amountPaid||0]})]}),e.jsxs("div",{className:"rounded-xl border border-slate-200 bg-white p-3 lg:col-span-2",children:[e.jsx("h3",{className:"text-sm font-semibold text-slate-900",children:"All Cluster Points"}),e.jsx("div",{className:"mt-2 grid grid-cols-2 gap-2 sm:grid-cols-4 lg:grid-cols-5",children:Zn(o.results).map(P=>e.jsxs("div",{className:"rounded-lg border border-slate-200 bg-slate-50 px-2 py-2 text-xs",children:[e.jsxs("p",{className:"font-semibold text-slate-700",children:["Cluster ",P.cluster]}),e.jsx("p",{className:"mt-1 font-mono text-slate-900",children:Yn(P.score)})]},`${o.code}-cluster-${P.cluster}`))}),e.jsxs("p",{className:"mt-3 text-xs text-slate-500",children:["Graded subjects: ",vn.length," ",vn.length?`(${vn.map(([P,Nn])=>`${P}:${Nn}`).join(", ")})`:""]})]})]})})}):null]},o.code)})]})]})}),e.jsxs("div",{className:"mt-4 flex flex-wrap items-center justify-between gap-3",children:[e.jsxs("p",{className:"text-sm text-slate-600",children:["Showing ",mn,"-",hn," of ",G.length]}),e.jsxs("div",{className:"flex items-center gap-1.5",children:[e.jsxs("button",{type:"button",onClick:()=>g(o=>Math.max(1,o-1)),disabled:y<=1,className:"inline-flex items-center justify-center gap-1 rounded-lg border border-slate-300 bg-white px-3 py-1.5 text-sm font-semibold text-slate-700 transition enabled:hover:bg-slate-100 disabled:cursor-not-allowed disabled:text-slate-400",children:[e.jsx(ie,{className:"h-4 w-4"}),"Prev"]}),an.map(o=>e.jsx("button",{type:"button",onClick:()=>g(o),className:`inline-flex items-center justify-center rounded-lg border px-3 py-1.5 text-sm font-semibold transition ${o===y?"border-slate-900 bg-slate-900 text-white":"border-slate-300 bg-white text-slate-700 hover:bg-slate-100"}`,children:o},`page-${o}`)),e.jsxs("button",{type:"button",onClick:()=>g(o=>Math.min(J,o+1)),disabled:y>=J,className:"inline-flex items-center justify-center gap-1 rounded-lg border border-slate-300 bg-white px-3 py-1.5 text-sm font-semibold text-slate-700 transition enabled:hover:bg-slate-100 disabled:cursor-not-allowed disabled:text-slate-400",children:["Next",e.jsx(te,{className:"h-4 w-4"})]})]})]})]}),Y.code?e.jsx("div",{className:"fixed inset-0 z-40 flex items-center justify-center bg-slate-900/40 p-4",children:e.jsxs("div",{className:"w-full max-w-lg rounded-2xl border border-slate-200 bg-white p-6 shadow-xl",children:[e.jsxs("h3",{className:"text-lg font-semibold text-slate-900",children:["Edit Session ",Y.code]}),e.jsx("p",{className:"mt-1 text-sm text-slate-600",children:"Update user contact details, payment amount, and qualification flag."}),e.jsxs("form",{onSubmit:Z,className:"mt-4 grid gap-4",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"edit_session_email",className:"mb-1 block text-sm font-medium text-slate-700",children:"Email"}),e.jsx("input",{id:"edit_session_email",type:"email",value:Y.email,onChange:o=>v(R=>({...R,email:o.target.value})),className:"ui-input"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"edit_session_phone",className:"mb-1 block text-sm font-medium text-slate-700",children:"Phone Number"}),e.jsx("input",{id:"edit_session_phone",type:"text",value:Y.phoneNumber,onChange:o=>v(R=>({...R,phoneNumber:o.target.value})),className:"ui-input"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"edit_session_amount",className:"mb-1 block text-sm font-medium text-slate-700",children:"Amount Paid"}),e.jsx("input",{id:"edit_session_amount",type:"number",min:0,step:"0.01",value:Y.amountPaid,onChange:o=>v(R=>({...R,amountPaid:o.target.value})),className:"ui-input"})]}),e.jsxs("label",{className:"inline-flex items-center gap-2 text-sm font-medium text-slate-700",children:[e.jsx("input",{type:"checkbox",checked:Y.medicineEligible,onChange:o=>v(R=>({...R,medicineEligible:o.target.checked})),className:"ui-checkbox"}),"Medicine Eligible"]}),e.jsxs("div",{className:"mt-2 flex items-center justify-end gap-2",children:[e.jsxs("button",{type:"button",onClick:K,disabled:H,className:"inline-flex items-center justify-center gap-1.5 rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition enabled:hover:bg-slate-100 disabled:cursor-not-allowed disabled:text-slate-400",children:[e.jsx(se,{className:"h-4 w-4"}),"Cancel"]}),e.jsxs("button",{type:"submit",disabled:H,className:"inline-flex items-center justify-center gap-1.5 rounded-lg bg-cyan-600 px-4 py-2 text-sm font-semibold text-white transition enabled:hover:bg-cyan-500 disabled:cursor-not-allowed disabled:bg-slate-400",children:[e.jsx(Gn,{className:"h-4 w-4"}),H?"Saving...":"Save Changes"]})]})]})]})}):null]})}const on={darajaPayment:"/api/payments",darajaQuery:"/api/payments/query",email:"/sendEmail",calculateCluster:"/calculateClusterPoints"},cr=async r=>{try{const i=await r.text();return i?JSON.parse(i):null}catch{return null}},On=async({url:r,headers:i,body:n})=>{const t=await fetch(r,{method:"POST",credentials:"include",headers:i||{},body:n||void 0}),s=await cr(t);return{ok:t.ok,status:t.status,data:s}},un=(r,i)=>{const n=(r==null?void 0:r.data)||{},t=(n==null?void 0:n.error)||(n==null?void 0:n.message)||(n==null?void 0:n.errorMessage)||(n==null?void 0:n.ResultDesc);return t?String(t):i},dn=r=>r&&typeof r=="object"&&"data"in r&&r.success!==!1?r.data:r,Nr=r=>({source:"local-engine",results:ue(r),medicineEligible:Re(r)}),Ur=async r=>{const i=(r==null?void 0:r["phone number"])||(r==null?void 0:r.phone_number)||(r==null?void 0:r.phoneNumber)||(r==null?void 0:r.phone)||"",n=Number((r==null?void 0:r.amount)??0),t=await On({url:on.darajaPayment,headers:{"Content-Type":"application/json"},body:JSON.stringify({phone_number:i,amount:n,account_reference:String((r==null?void 0:r.account_reference)||(r==null?void 0:r.accountReference)||"KUCCPS-CLUSTER"),transaction_description:String((r==null?void 0:r.transaction_description)||(r==null?void 0:r.transactionDesc)||"Cluster payment")})});if(!t.ok)throw new Error(un(t,"Unable to initiate STK push."));return dn(t.data)},Ar=async r=>{const i=String((r==null?void 0:r.email)||"").trim(),n=String(r==null?void 0:r.subject).trim(),t=String((r==null?void 0:r.message)||"");if(!i||!n||!t)throw new Error("Email, subject and message are required.");const s=new URLSearchParams({email:i,subject:n,message:t}).toString(),a=[{url:on.email,headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,subject:n,message:t})},{url:`${on.email}${on.email.includes("?")?"&":"?"}${s}`,headers:{},body:void 0}],l=[],N=[];for(const C of a){const c=await On(C);if(c.ok)return dn(c.data);l.push(c.status),N.push(un(c,`HTTP ${c.status}`))}const U=N.filter(Boolean).join(" | ");throw new Error(`Email API request failed. ${U||`Status codes: ${l.join(", ")}.`}`)},Tr=async({checkoutRequestId:r})=>{const i={checkoutRequestId:String(r||"").trim()};if(!i.checkoutRequestId)throw new Error("checkoutRequestId is required.");const n=await On({url:on.darajaQuery,headers:{"Content-Type":"application/json"},body:JSON.stringify(i)});if(n.ok)return dn(n.data);throw new Error(un(n,"Unable to fetch payment status."))},Jn=r=>new Promise(i=>window.setTimeout(i,r)),yr=async({checkoutRequestId:r,timeoutMs:i=3e5,intervalMs:n=3e3,onStatus:t})=>{var l;const s=Date.now();let a="";for(;Date.now()-s<=i;){let N;try{N=await Tr({checkoutRequestId:r})}catch(c){a=String((c==null?void 0:c.message)||"").trim()||a,t==null||t({status:"pending",transientError:!0,resultDesc:a||"Temporary payment status check issue."}),await Jn(n);continue}t==null||t(N);const U=String((N==null?void 0:N.status)||"").trim().toLowerCase(),C=Number(((l=N==null?void 0:N.queryResponse)==null?void 0:l.ResultCode)??NaN);if(U==="success"||C===0)return N;if(U==="failed")throw new Error((N==null?void 0:N.resultDesc)||"Payment failed. Please try again.");await Jn(n)}throw new Error(a?`Timed out while waiting for M-Pesa confirmation. Last status: ${a}`:"Timed out while waiting for M-Pesa confirmation.")},Cr=async({grades:r,checkoutRequestId:i,merchantRequestId:n})=>{const t={grades:r||{},checkoutRequestId:String(i||"").trim(),merchantRequestId:String(n||"").trim()};if(!t.checkoutRequestId&&!t.merchantRequestId)throw new Error("checkoutRequestId or merchantRequestId is required before calculation.");const s=await On({url:on.calculateCluster,headers:{"Content-Type":"application/json"},body:JSON.stringify(t)});if(s.ok)return dn(s.data);throw new Error(un(s,"Unable to calculate cluster points after payment."))},Sr=r=>r==="saved-session"?"Saved Session":r==="firebase-function"?"Firebase Function":"Local Cluster Engine",Rr=({code:r})=>["Your KUCCPS cluster calculation is ready.","",`Access code: ${r}`,"","Use this code on the home page to open your saved cluster points and continue course selection."].join(`
`),Or=/^[^\s@]+@[^\s@]+\.[^\s@]+$/,ur=r=>Or.test(String(r||"").trim()),dr=r=>{const i=String(r||"").replace(/\D/g,"");return i.length===10&&i.startsWith("0")?`254${i.slice(1)}`:i.length===9&&i.startsWith("7")?`254${i}`:i.length===12&&i.startsWith("254")?i:null},qn=()=>Object.fromEntries(Object.keys(Vn).map(r=>[r,""])),mr="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm transition hover:shadow",hr="mt-3 inline-flex w-full items-center justify-between rounded-lg border border-slate-300 bg-slate-50 px-3 py-2 text-sm font-medium text-slate-700 transition hover:bg-slate-100",vr="ui-select";function gr({onCalculationReady:r,payableAmount:i,gradeOptions:n}){const t=Cn(),[s,a]=I.useState(qn()),[l,N]=I.useState(Object.fromEntries(Dn.map((A,d)=>[A.title,d===0]))),[U,C]=I.useState(!1),[c,O]=I.useState(""),[T,S]=I.useState(""),[x,u]=I.useState(""),[h,y]=I.useState(null),[g,Y]=I.useState(""),[v,H]=I.useState(""),[F,q]=I.useState(!1),[_,j]=I.useState(""),$=(A,d)=>{a(m=>({...m,[A]:d}))},k=A=>Vn[A]||A,G=()=>Object.entries(s).filter(([,A])=>A&&A!=="").map(([A])=>A),J=A=>{N(d=>{const m=Object.fromEntries(Object.keys(d).map(f=>[f,!1]));return m[A]=!d[A],m})},W=A=>{A.preventDefault(),j(""),S(""),u("");const d=G();if(d.length<7){j("Select grades for at least 7 subjects across all groups to compute cluster points.");return}const m=qn();d.forEach(K=>{m[K]=s[K]});const f=String(v||"").trim();if(!ur(f)){j("Enter a valid email address.");return}y(m),Y(f),C(!0)},M=async A=>{if(A.preventDefault(),S(""),u(""),!h){S("Please submit your grades and email first.");return}if(!g){S("Enter a valid email before continuing.");return}const d=dr(c);if(!d){S("Enter a valid M-Pesa phone number e.g. 0712345678 or 254712345678.");return}q(!0);try{u("Sending the STK push to your phone...");const m=await Ur({amount:i,phone_number:d,phone:d,phoneNumber:d,"phone number":d}),f=String((m==null?void 0:m.CheckoutRequestID)||(m==null?void 0:m.checkoutRequestId)||"").trim(),K=String((m==null?void 0:m.MerchantRequestID)||(m==null?void 0:m.merchantRequestId)||"").trim();if(!f&&!K)throw new Error("STK push response did not include a payment reference.");u("STK push sent. Complete the payment on your phone. Waiting for confirmation...");const Z=await yr({checkoutRequestId:f,merchantRequestId:K,onStatus:R=>{(R==null?void 0:R.status)==="pending"&&u("Waiting for M-Pesa confirmation. Complete the prompt on your phone to continue.")}});u("Payment confirmed. Calculating cluster points...");let z,tn="";try{z=await Cr({grades:h,checkoutRequestId:f,merchantRequestId:K})}catch(R){z=Nr(h),tn=String((R==null?void 0:R.message)||"").trim()||"Backend calculation API was unavailable, so a local verified fallback was used."}const{session:an,storage:mn,warning:hn}=await Ge({email:g,phoneNumber:d,amountPaid:i,grades:h,results:z.results,medicineEligible:z.medicineEligible,paymentResponse:{initiation:m,confirmation:Z}}),o=["Payment confirmed."];tn&&o.push(`Cluster points calculated locally (${tn}).`),mn==="local"?o.push(hn||"Firebase save failed. Session was saved on this browser only, so code restore works only on this device."):o.push("Session saved to Firebase.");try{await Ar({email:g,subject:"KUCCPS Cluster Calculator Access Code",message:Rr({code:an.code})}),o.push(`Access code sent to ${g}.`)}catch(R){const L=R instanceof Error?R.message:"";o.push(L?`Email delivery failed (${L}). Save this code: ${an.code}.`:`Email delivery failed. Save this code: ${an.code}.`)}r({grades:h,results:z.results,source:z.source,accessCode:an.code,sessionMessage:o.join(" ")}),C(!1),S(""),u(""),j(""),t("/results")}catch(m){const f=m instanceof Error?m.message:"Payment or calculation failed.";S(f),j(f),u("")}finally{q(!1)}};return e.jsxs("section",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsx("h1",{className:"text-2xl font-semibold tracking-tight",children:"Cluster Points Calculator"}),e.jsx("p",{className:"mt-2 text-sm text-slate-600",children:"Enter your grades and email, then start payment. Cluster points are only shown after the M-Pesa payment is confirmed."}),e.jsxs("p",{className:"mt-1 text-sm font-medium text-emerald-700",children:["Amount: KES ",i]}),e.jsxs("form",{onSubmit:W,className:"mt-6 space-y-6",children:[e.jsx(p,{tone:"danger",message:_}),e.jsx("div",{className:"grid gap-5 xl:grid-cols-2",children:Dn.map(A=>e.jsxs("article",{className:mr,children:[e.jsx("div",{className:"flex items-start justify-between gap-3",children:e.jsxs("div",{children:[e.jsx("h2",{className:"text-base font-semibold text-slate-900",children:A.title}),e.jsx("p",{className:"mt-1 text-xs text-slate-500",children:A.required?"Core group. Enter grades for all listed subjects.":"Optional group. Fill available subjects."})]})}),e.jsxs("button",{type:"button",onClick:()=>J(A.title),className:hr,children:[e.jsx("span",{children:l[A.title]?"Hide grade fields":"Show grade fields"}),e.jsx(ae,{className:`h-4 w-4 text-slate-500 transition-transform ${l[A.title]?"rotate-180":"rotate-0"}`})]}),l[A.title]?e.jsx("div",{className:"mt-4 grid gap-3 sm:grid-cols-2",children:A.subjects.map(d=>e.jsxs("div",{children:[e.jsxs("label",{htmlFor:`${A.title}-${d}`,className:"mb-1 block text-sm font-medium text-slate-700",children:[k(d),A.required?e.jsx("span",{className:"text-rose-600",children:" *"}):null]}),e.jsxs("select",{id:`${A.title}-${d}`,value:s[d],onChange:m=>$(d,m.target.value),required:A.required,className:vr,children:[e.jsx("option",{value:"",children:"Select grade"}),n.map(m=>e.jsx("option",{value:m,children:m},m))]})]},d))}):null]},A.title))}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"email",className:"mb-1 block text-sm font-medium text-slate-700",children:"Email Address (for access code)"}),e.jsx("input",{id:"email",type:"email",value:v,onChange:A=>H(A.target.value),placeholder:"you@example.com",required:!0,className:"ui-input"})]}),e.jsx("button",{type:"submit",disabled:F,className:"inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-slate-900 to-slate-700 px-4 py-2 text-sm font-semibold text-white transition hover:from-slate-800 hover:to-slate-700",children:F?"Processing...":"Calculate Cluster Points"})]}),U?e.jsx("div",{className:"fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 px-4",children:e.jsxs("div",{className:"w-full max-w-md rounded-2xl border border-slate-200 bg-white p-6 shadow-xl",children:[e.jsx("h2",{className:"text-lg font-semibold text-slate-900",children:"Enter M-Pesa Phone Number"}),e.jsxs("p",{className:"mt-1 text-sm text-slate-600",children:["We will send an STK push for KES ",i,". Your cluster points remain locked until the payment is confirmed."]}),e.jsxs("form",{onSubmit:M,className:"mt-4 space-y-4",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"dialog_phone_number",className:"mb-1 block text-sm font-medium text-slate-700",children:"M-Pesa Phone Number"}),e.jsx("input",{id:"dialog_phone_number",type:"tel",value:c,onChange:A=>O(A.target.value),placeholder:"0712345678",autoFocus:!0,required:!0,className:"ui-input"})]}),e.jsx(p,{tone:"info",message:x}),e.jsx(p,{tone:"danger",message:T}),e.jsxs("div",{className:"flex items-center justify-end gap-3",children:[e.jsx("button",{type:"button",onClick:()=>{F||(C(!1),S(""))},disabled:F,className:"inline-flex items-center justify-center rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-100 disabled:cursor-not-allowed disabled:opacity-60",children:"Cancel"}),e.jsx("button",{type:"submit",disabled:F,className:"inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-slate-900 to-slate-700 px-4 py-2 text-sm font-semibold text-white transition enabled:hover:from-slate-800 enabled:hover:to-slate-700 disabled:cursor-not-allowed disabled:bg-slate-400",children:F?"Processing...":"Send STK Push"})]})]})]})}):null]})}const Mn={A:12,"A-":11,"B+":10,B:9,"B-":8,"C+":7,C:6,"C-":5,"D+":4,D:3,"D-":2,E:1},Yr={ENGLISH:"ENG",KISWAHILI:"KIS",MATHEMATICS:"MAT",MATH:"MAT",BIOLOGY:"BIO",CHEMISTRY:"CHE",PHYSICS:"PHY","GENERAL SCIENCE":"GSC",HISTORY:"HAG","HISTORY & GOVERNMENT":"HAG",GEOGRAPHY:"GEO",CRE:"CRE",IRE:"IRE",HRE:"HRE","COMPUTER STUDIES":"CMP",AGRICULTURE:"AGR","ART & DESIGN":"ARD","HOME SCIENCE":"HSC","BUSINESS STUDIES":"BST",FRENCH:"FRE",GERMAN:"GER",MUSIC:"MUS",ARABIC:"ARB"},Mr=(r,i)=>{const n=[];for(const[t,s]of Object.entries(i||{})){const a=String(s||"").trim().toUpperCase();if(!(a in Mn))continue;const l=String(t).split("/").map(c=>{const O=c.trim().toUpperCase();return Yr[O]||O});let N=!1,U=null,C=null;for(const c of l){const O=(r[c]||"").toUpperCase();if(O){if((Mn[O]||0)>=Mn[a]){N=!0;break}U=c,C=O}}N||n.push({subject:t,required:a,studentSubject:U,studentGrade:C})}return{passed:n.length===0,failed:n}};function fr({results:r,grades:i,courseCatalog:n}){const[t]=oe(),s=Number(t.get("cluster")||0),a=t.get("course")||"";if(!r||!i)return e.jsx(rn,{to:"/",replace:!0});if(!s||!a)return e.jsx(rn,{to:"/results",replace:!0});const N=(n[s]||[]).find(T=>T.name===a);if(!N)return e.jsx(rn,{to:"/results",replace:!0});const U=Number(r[s]??r[String(s)]??0),C=Mr(i,N.requirements),c=[],O=T=>Number(T||0).toFixed(3).replace(/\.?0+$/,"");if(C.passed)for(const T of N.universities||[])U>=Number(T.cutoff)&&c.push(T);return e.jsxs("section",{className:"space-y-6",children:[e.jsxs("div",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsx("h1",{className:"text-2xl font-semibold tracking-tight",children:a}),e.jsxs("div",{className:"mt-3 flex flex-wrap gap-4 text-sm text-slate-700",children:[e.jsxs("p",{children:[e.jsx("span",{className:"font-semibold text-slate-900",children:"Cluster:"})," ",s]}),e.jsxs("p",{children:[e.jsx("span",{className:"font-semibold text-slate-900",children:"Cluster Points:"})," ",U]})]})]}),C.passed?c.length?e.jsxs("article",{className:"rounded-2xl border border-emerald-200 bg-white p-5 shadow-sm",children:[e.jsx("h2",{className:"text-lg font-semibold text-emerald-900",children:"Qualified Universities"}),e.jsxs("p",{className:"mt-1 text-sm text-slate-600",children:["You qualify for ",c.length," ",c.length===1?"university":"universities"," based on your cluster points."]}),e.jsx("div",{className:"mt-4 overflow-x-auto rounded-xl border border-emerald-100",children:e.jsxs("table",{className:"min-w-full divide-y divide-emerald-100 text-sm",children:[e.jsx("thead",{className:"bg-emerald-50 text-left text-emerald-900",children:e.jsxs("tr",{children:[e.jsx("th",{className:"px-3 py-2 font-semibold",children:"University"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Cutoff"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Your Points"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Margin"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Status"})]})}),e.jsx("tbody",{className:"divide-y divide-emerald-50 bg-white text-slate-700",children:c.slice().sort((T,S)=>Number(S.cutoff)-Number(T.cutoff)).map(T=>e.jsxs("tr",{className:"hover:bg-emerald-50/40",children:[e.jsx("td",{className:"px-3 py-2 font-medium text-slate-900",children:T.name}),e.jsx("td",{className:"px-3 py-2",children:O(T.cutoff)}),e.jsx("td",{className:"px-3 py-2",children:O(U)}),e.jsxs("td",{className:"px-3 py-2 text-emerald-700",children:["+",O(U-Number(T.cutoff))]}),e.jsx("td",{className:"px-3 py-2",children:e.jsx("span",{className:"rounded-full border border-emerald-200 bg-emerald-50 px-2 py-1 text-xs font-semibold text-emerald-800",children:"Qualified"})})]},`${T.name}-${T.cutoff}`))})]})})]}):e.jsxs("article",{className:"rounded-2xl border border-amber-200 bg-amber-50 p-5",children:[e.jsx("h2",{className:"text-lg font-semibold text-amber-900",children:"Not Qualified for Any University"}),e.jsx("p",{className:"mt-2 text-sm text-amber-900",children:"Based on your current cluster points, you do not qualify for any listed university for this course."})]}):e.jsxs("div",{className:"space-y-4",children:[e.jsxs("article",{className:"rounded-2xl border border-amber-200 bg-amber-50 p-5",children:[e.jsx("h2",{className:"text-lg font-semibold text-amber-900",children:"Not Qualified for Any University"}),e.jsx("p",{className:"mt-2 text-sm text-amber-900",children:"You do not meet subject requirements for this course, so you are not qualified for any listed university."})]}),e.jsxs("article",{className:"rounded-2xl border border-rose-200 bg-rose-50 p-5",children:[e.jsx("h2",{className:"text-lg font-semibold text-rose-900",children:"Subject Requirements Not Met"}),e.jsx("ul",{className:"mt-3 space-y-1 text-sm text-rose-900",children:C.failed.map(T=>e.jsxs("li",{children:[T.subject," required >= ",T.required,T.studentSubject?` (you had ${T.studentSubject}: ${T.studentGrade})`:" (subject not done)"]},`${T.subject}-${T.required}`))})]})]}),e.jsx("div",{children:e.jsx(En,{to:"/results",className:"text-sm font-medium text-slate-700 hover:text-slate-900",children:"Back to Results"})})]})}function Vr({onRestoreByCode:r,payableAmount:i}){const n=Cn(),[t,s]=I.useState(""),[a,l]=I.useState(""),[N,U]=I.useState(!1),C=async c=>{c.preventDefault(),l(""),U(!0);try{if(!await r(t)){l("Code not found. Confirm the code sent to your email.");return}n("/results")}catch(O){l(O.message||"Unable to load code.")}finally{U(!1)}};return e.jsxs("section",{className:"rounded-2xl border border-slate-200 bg-white p-8 shadow-sm md:p-12",children:[e.jsx("h1",{className:"mt-4 max-w-3xl text-3xl font-semibold tracking-tight text-slate-900 md:text-5xl",children:"Start a new calculation or continue with your access code"}),e.jsxs("p",{className:"mt-4 max-w-2xl text-base leading-relaxed text-slate-600 md:text-lg",children:["New users pay KES ",i,", then receive a unique code by email to reopen saved results later."]}),e.jsxs("div",{className:"mt-6 flex flex-row items-center gap-4",children:[e.jsx("div",{className:"mt-8",children:e.jsx(En,{to:"/calculator",className:"inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-slate-900 to-slate-700 px-6 py-3 text-sm font-semibold text-white shadow-sm transition hover:from-slate-800 hover:to-slate-700",children:"Get Started"})}),e.jsxs("form",{onSubmit:C,className:"max-w-xl space-y-3 rounded-xl",children:[e.jsx("label",{htmlFor:"access_code",className:"block text-sm font-medium text-slate-700",children:"Have an access code? Paste it here"}),e.jsxs("div",{className:"flex flex-col gap-3 sm:flex-row",children:[e.jsx("input",{id:"access_code",type:"text",value:t,onChange:c=>s(c.target.value.toUpperCase()),placeholder:"e.g. 8F3KQ2P9",className:"ui-input",required:!0}),e.jsx("button",{type:"submit",disabled:N,className:"inline-flex items-center justify-center rounded-lg bg-emerald-700 px-6 py-2 text-sm font-semibold text-white transition enabled:hover:bg-emerald-600 disabled:cursor-not-allowed disabled:bg-emerald-400",children:N?"Opening...":"Open"})]}),e.jsx(p,{tone:"danger",message:a})]})]})]})}function Kr({clusters:r,getScore:i,courseCatalog:n,selectedCourses:t,onSelectCourse:s,onCheckCourse:a}){return e.jsx("div",{className:"mt-6 overflow-x-auto rounded-xl border border-slate-200",children:e.jsxs("table",{className:"min-w-full divide-y divide-slate-200 text-sm",children:[e.jsx("thead",{className:"bg-slate-100 text-left text-slate-700",children:e.jsxs("tr",{children:[e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Cluster"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Points"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Course Check"})]})}),e.jsx("tbody",{className:"divide-y divide-slate-100 bg-white text-slate-700",children:r.map(l=>{const N=n[l]||[];return e.jsxs("tr",{className:"align-top hover:bg-slate-50",children:[e.jsx("td",{className:"px-3 py-2 font-medium text-slate-900",children:l}),e.jsx("td",{className:"px-3 py-2",children:i(l)}),e.jsx("td",{className:"px-3 py-2",children:e.jsxs("div",{className:"flex flex-col gap-2 sm:flex-row",children:[e.jsxs("select",{value:t[l]||"",onChange:U=>s(l,U.target.value),className:"ui-select sm:max-w-sm",children:[e.jsx("option",{value:"",children:"Select Course"}),N.map(U=>e.jsx("option",{value:U.name,children:U.name},U.name))]}),e.jsx("button",{type:"button",disabled:!t[l],onClick:()=>a(l,t[l]),className:"inline-flex items-center justify-center rounded-lg bg-slate-900 px-3 py-2 text-xs font-semibold text-white transition enabled:hover:bg-slate-800 disabled:cursor-not-allowed disabled:bg-slate-400",children:"Check"})]})})]},l)})})]})})}function Lr({results:r,grades:i,source:n,courseCatalog:t,courseCatalogError:s,catalogLoading:a,accessCode:l,sessionMessage:N}){const U=Cn(),[C,c]=I.useState({});if(!r||!i)return e.jsx(rn,{to:"/",replace:!0});const O=Array.from({length:20},(S,x)=>x+1),T=S=>Number(r[S]??r[String(S)]??0);return e.jsxs("section",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsx("h1",{className:"text-2xl font-semibold tracking-tight",children:"All Cluster Points"}),e.jsx("p",{className:"mt-2 text-sm text-slate-600",children:"Select a course to evaluate your qualification details."}),e.jsxs("p",{className:"mt-1 text-xs font-medium text-slate-500",children:["Calculation source: ",Sr(n)]}),l?e.jsx(p,{className:"mt-3",tone:"success",message:`Access code: ${l}`}):null,e.jsx(p,{className:"mt-2",tone:"info",message:N}),a?e.jsx(p,{className:"mt-2",tone:"info",message:"Loading course catalog..."}):null,e.jsx(p,{className:"mt-2",tone:"danger",message:s}),e.jsx(Kr,{clusters:O,getScore:T,courseCatalog:t,selectedCourses:C,onSelectCourse:(S,x)=>c(u=>({...u,[S]:x})),onCheckCourse:(S,x)=>U(`/course-result?cluster=${S}&course=${encodeURIComponent(x)}`)})]})}const br=()=>Object.fromEntries(Object.keys(Vn).map(r=>[r,""]));function xr(){const r=$n(),[i,n]=I.useState(null),[t,s]=I.useState(null),[a,l]=I.useState("local-engine"),[N,U]=I.useState(""),[C,c]=I.useState(""),O=I.useMemo(()=>Ke(),[]),T=r.pathname.startsWith("/admin"),{courseCatalog:S,catalogLoading:x,courseCatalogError:u,saveCatalog:h,saveSingleCourse:y}=Ze({mode:T?"admin":"public"}),{adminUser:g,adminProfile:Y,authLoading:v,authWorking:H,authError:F,isAdminAuthenticated:q,login:_,loginWithGoogle:j,logout:$,addRegularAdmin:k}=Te({enabled:T}),G=I.useCallback(async f=>{const K=await He(f);return!K||!K.results?null:(n(K.grades||br()),s(K.results||null),l("saved-session"),U(K.code),c(K.createdAt?`Loaded ${K.storage==="local"?"local":"saved"} session from ${new Date(K.createdAt).toLocaleString()}.`:`Loaded ${K.storage==="local"?"local":"saved"} session.`),K)},[]),J=I.useCallback(async f=>{await h(f)},[h]),W=I.useCallback(async f=>{await y(f)},[y]),M=I.useCallback(async(f,K)=>await _(f,K),[_]),A=I.useCallback(async()=>await j(),[j]),d=I.useCallback(async()=>{await $()},[$]),m=I.useCallback(f=>v?e.jsx("section",{className:"mx-auto max-w-xl rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:e.jsx(p,{tone:"info",message:"Checking admin authentication..."})}):q?f:e.jsx(rn,{to:"/admin/login",replace:!0}),[v,q]);return e.jsx(Ue,{children:e.jsxs(Ee,{children:[e.jsx(Q,{path:"/",element:e.jsx(Vr,{onRestoreByCode:G,payableAmount:Bn})}),e.jsx(Q,{path:"/admin/login",element:e.jsx(ze,{isAuthenticated:q,onLogin:M,onGoogleLogin:A,authError:F,isLoading:H||v})}),e.jsx(Q,{path:"/admin",element:m(e.jsx(tr,{firebaseConfigured:O,onUploadCatalog:J,onAddSingleCourse:W,onLogout:d,onAddRegularAdmin:k,adminProfile:Y,adminEmail:(g==null?void 0:g.email)||"",authError:F,courseCatalog:S}))}),e.jsx(Q,{path:"/admin/sessions",element:m(e.jsx(lr,{firebaseConfigured:O}))}),e.jsx(Q,{path:"/calculator",element:e.jsx(gr,{gradeOptions:Ae,payableAmount:Bn,onCalculationReady:({grades:f,results:K,source:Z,accessCode:z,sessionMessage:tn})=>{n(f),s(K),l(Z),U(z||""),c(tn||"")}})}),e.jsx(Q,{path:"/payment",element:e.jsx(rn,{to:"/calculator",replace:!0})}),e.jsx(Q,{path:"/results",element:e.jsx(Lr,{results:t,grades:i,source:a,courseCatalog:S,courseCatalogError:u,catalogLoading:x,accessCode:N,sessionMessage:C})}),e.jsx(Q,{path:"/course-result",element:e.jsx(fr,{results:t,grades:i,courseCatalog:S})}),e.jsx(Q,{path:"*",element:e.jsx(rn,{to:"/",replace:!0})})]})})}Ie.createRoot(document.getElementById("root")).render(e.jsx(le.StrictMode,{children:e.jsx(ce,{children:e.jsx(xr,{})})}));
