...
exports.computeAllClusters = exports.computeCluster = exports.medicineEligibility = exports.SUBJECT_GROUPS = exports.SUBJECTS = exports.GRADE_POINTS = void 0;
...
const best = (scores, subjects) => Math.max(...subjects.map((s) => (s in scores ? scores[s] : 0)), 0);
...
const medicineEligibility = (gradesByCode) => {
    ...
    return required.every((code) => gradesByCode[code] && gradesByCode[code] in exports.GRADE_POINTS);
};
...
const computeCluster = (cluster, rawGrades) => {
    ...
    for (const [subject, grade] of Object.entries(rawGrades)) {
        if (grade in exports.GRADE_POINTS)
            scores[subject] = exports.GRADE_POINTS[grade];
    }
